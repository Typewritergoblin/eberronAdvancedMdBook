# Monsters (T) - Monster Manual - Dungeons & Dragons - Sources - D&D Beyond
...
| --- | --- |
| 1 | Evidence of a magic spell reflected back on its caster, like [Ice Knife](/spells/2619171-ice-knife "//www.dndbeyond.com/spells/2619171-tooltip?disable-webm=1&disable-webm=1") or [Melf’s Acid Arrow](/spells/2619032-melfs-acid-arrow "//www.dndbeyond.com/spells/2619032-tooltip?disable-webm=1&disable-webm=1"). |
...
***Reflective Carapace.*** If the tarrasque is targeted by a [Magic Missile](/spells/2619022-magic-missile "//www.dndbeyond.com/spells/2619022-tooltip?disable-webm=1&disable-webm=1") spell or a spell that requires a ranged attack roll, roll 1d6. On a **1–5**, the tarrasque is unaffected. On a **6**, the tarrasque is unaffected and reflects the spell, turning the caster into the target.
...
***Bite.*** *Melee Attack Roll:* +19, reach 15 ft. *Hit:* 36 (4d12 + 10) Piercing damage, and the target has the [Grappled](/sources/dnd/free-rules/rules-glossary#GrappledCondition "//www.dndbeyond.com/conditions/6-tooltip?disable-webm=1&disable-webm=1") condition (escape DC 20). Until the grapple ends, the target has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition and can’t teleport.

***Claw.*** *Melee Attack Roll:* +19, reach 15 ft. *Hit:* 28 (4d8 + 10) Slashing damage.

***Tail.*** *Melee Attack Roll:* +19, reach 30 ft. *Hit:* 23 (3d8 + 10) Bludgeoning damage. If the target is a Huge or smaller creature, it has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition.

***Thunderous Bellow (Recharge 5–6).*** *Constitution Saving Throw:* DC 27, each creature and each object that isn’t being worn or carried in a 150-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). *Failure:* 78 (12d12) Thunder damage, and the target has the [Deafened](/sources/dnd/free-rules/rules-glossary#DeafenedCondition "//www.dndbeyond.com/conditions/3-tooltip?disable-webm=1&disable-webm=1") and [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") conditions until the end of its next turn. *Success:* Half damage only.

Bonus Actions

***Swallow.*** *Strength Saving Throw:* DC 27, one Large or smaller creature [Grappled](/sources/dnd/free-rules/rules-glossary#GrappledCondition "//www.dndbeyond.com/conditions/6-tooltip?disable-webm=1&disable-webm=1") by the tarrasque (it can have up to six creatures swallowed at a time). *Failure:* The target is swallowed, and the Grappled condition ends. A swallowed creature has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") and [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") conditions and can’t teleport, it has [Total Cover](/sources/dnd/free-rules/rules-glossary#Cover "//www.dndbeyond.com/rules-glossary/33-tooltip?disable-webm=1&disable-webm=1") against attacks and other effects outside the tarrasque, and it takes 56 (16d6) Acid damage at the start of each of the tarrasque’s turns.

If the tarrasque takes 60 damage or more on a single turn from a creature inside it, the tarrasque must succeed on a DC 20 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, each of which falls in a space within 10 feet of the tarrasque and has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition. If the tarrasque dies, any swallowed creature no longer has the Restrained condition and can escape from the corpse using 20 feet of movement, exiting Prone.
...
***World-Shaking Movement.*** The tarrasque moves up to its Speed. At the end of this movement, the tarrasque creates an instantaneous shock wave in a 60-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") originating from itself. Creatures in that area lose [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1") and, if Medium or smaller, have the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition. The tarrasque can’t take this action again until the start of its next turn.

## Thri-kreen

Mantid Psychics and Scavengers

**Habitat:** Desert, Grassland; **Treasure:** [Armaments](/sources/dnd/dmg-2024/random-magic-items#ArmamentsTables)
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +4, [Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1") +8
...
**1/Day Each:** [Detect Thoughts](/spells/2619099-detect-thoughts "//www.dndbeyond.com/spells/2619099-tooltip?disable-webm=1&disable-webm=1"), [Sending](/spells/2619015-sending "//www.dndbeyond.com/spells/2619015-tooltip?disable-webm=1&disable-webm=1"), [Synaptic Static](/spells/2619129-synaptic-static "//www.dndbeyond.com/spells/2619129-tooltip?disable-webm=1&disable-webm=1")
...
**Gear** [Chain Mail](/equipment/16-chain-mail "//www.dndbeyond.com/armor/16-tooltip?disable-webm=1&disable-webm=1"), [Heavy Crossbow](/equipment/36-crossbow-heavy "//www.dndbeyond.com/weapons/36-tooltip?disable-webm=1&disable-webm=1"), [Warhammer](/equipment/33-warhammer "//www.dndbeyond.com/weapons/33-tooltip?disable-webm=1&disable-webm=1")
...
| 2 | Growing atop the entrance to a dungeon or portal to the [Feywild](/sources/dnd/dmg-2024/cosmology#Feywild "//www.dndbeyond.com/lore-glossary/266-tooltip?disable-webm=1&disable-webm=1"). |
| 3 | Home to a community of [pixies](/monsters/5195164-pixie "//www.dndbeyond.com/monsters/5195164-tooltip?disable-webm=1&disable-webm=1") or [sprites](/monsters/4775845-sprite "//www.dndbeyond.com/monsters/4775845-tooltip?disable-webm=1&disable-webm=1"). |
...
**Habitat:** Underdark; **Treasure:** [Armaments](/sources/dnd/dmg-2024/random-magic-items#ArmamentsTables)
...
With features similar to those of pale cave lizards, troglodytes stalk the [Underdark](/sources/dnd/dmg-2024/lore-glossary#UnderdarkThe "//www.dndbeyond.com/lore-glossary/216-tooltip?disable-webm=1&disable-webm=1") in an endless hunt for food. Troglodytes consume almost anything, including bones, giant insects, and other subterranean dwellers. They prey on subterranean communities and those near entrances to the Underdark, stealing livestock and kidnapping residents.
...
***Stench.*** *Constitution Saving Throw:* DC 12, any creature (other than a troglodyte) that starts its turn in a 5-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") originating from the troglodyte. *Failure:* The target has the [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1") condition until the start of its next turn. *Success:* The target is immune to the Stench of all troglodytes for 1 hour.
...
***Loathsome Limbs (4/Day).*** If the troll ends any turn [Bloodied](/sources/dnd/free-rules/rules-glossary#Bloodied "//www.dndbeyond.com/rules-glossary/14-tooltip?disable-webm=1&disable-webm=1") and took 15+ Slashing damage during that turn, one of the troll’s limbs is severed, falls into the troll’s space, and becomes a [Troll Limb](/monsters/5195240-troll-limb "//www.dndbeyond.com/monsters/5195240-tooltip?disable-webm=1&disable-webm=1"). The limb acts immediately after the troll’s turn. The troll has 1 [Exhaustion](/sources/dnd/free-rules/rules-glossary#ExhaustionCondition "//www.dndbeyond.com/conditions/4-tooltip?disable-webm=1&disable-webm=1") level for each missing limb, and it grows replacement limbs the next time it regains Hit Points.
...
***Troll Spawn.*** The limb uncannily has the same senses as a whole troll. If the limb isn’t destroyed within 24 hours, roll 1d12. On a 12, the limb turns into a [Troll](/monsters/5195241-troll "//www.dndbeyond.com/monsters/5195241-tooltip?disable-webm=1&disable-webm=1"). Otherwise, the limb withers away.
...
*Source: https://www.dndbeyond.com/sources/dnd/mm-2024/monsters-t*