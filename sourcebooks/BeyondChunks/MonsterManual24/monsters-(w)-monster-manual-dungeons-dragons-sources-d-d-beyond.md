# Monsters (W) - Monster Manual - Dungeons & Dragons - Sources - D&D Beyond
...
**Gear** [Chain Shirt](/equipment/12-chain-shirt "//www.dndbeyond.com/armor/12-tooltip?disable-webm=1&disable-webm=1"), [Spear](/equipment/14-spear "//www.dndbeyond.com/weapons/14-tooltip?disable-webm=1&disable-webm=1")
...
**Skills** [Athletics](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/2-tooltip?disable-webm=1&disable-webm=1") +5, [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +2

**Gear** [Greatsword](/equipment/22-greatsword "//www.dndbeyond.com/weapons/22-tooltip?disable-webm=1&disable-webm=1"), [Heavy Crossbow](/equipment/36-crossbow-heavy "//www.dndbeyond.com/weapons/36-tooltip?disable-webm=1&disable-webm=1"), [Splint Armor](/equipment/17-splint "//www.dndbeyond.com/armor/17-tooltip?disable-webm=1&disable-webm=1")
...
**Gear** [Greatsword](/equipment/22-greatsword "//www.dndbeyond.com/weapons/22-tooltip?disable-webm=1&disable-webm=1"), [Longbow](/equipment/37-longbow "//www.dndbeyond.com/weapons/37-tooltip?disable-webm=1&disable-webm=1"), [Plate Armor](/equipment/18-plate "//www.dndbeyond.com/armor/18-tooltip?disable-webm=1&disable-webm=1")
...
**Maneuver.** One ally who can see or hear the warrior can take a Reaction to move up to half the ally’s Speed without provoking [Opportunity Attacks](/sources/dnd/free-rules/rules-glossary#OpportunityAttack "//www.dndbeyond.com/actions/1001-tooltip?disable-webm=1&disable-webm=1").
...
***Tactical Charge.*** The warrior moves up to half its Speed straight toward an enemy it can see without provoking [Opportunity Attacks](/sources/dnd/free-rules/rules-glossary#OpportunityAttack "//www.dndbeyond.com/actions/1001-tooltip?disable-webm=1&disable-webm=1").
...
***Slam.*** *Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Bludgeoning damage. If the target is a Medium or smaller creature, it has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition.

***Whelm (Recharge 4–6).*** *Strength Saving Throw:* DC 15, each creature in the elemental’s space. *Failure:* 22 (4d8 + 4) Bludgeoning damage. If the target is a Large or smaller creature, it has the [Grappled](/sources/dnd/free-rules/rules-glossary#GrappledCondition "//www.dndbeyond.com/conditions/6-tooltip?disable-webm=1&disable-webm=1") condition (escape DC 14). Until the grapple ends, the target has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition, is [suffocating](/sources/dnd/free-rules/rules-glossary#SuffocationHazard "//www.dndbeyond.com/rules-glossary/112-tooltip?disable-webm=1&disable-webm=1") unless it can breathe water, and takes 9 (2d8) Bludgeoning damage at the start of each of the elemental’s turns. The elemental can grapple one Large creature or up to two Medium or smaller creatures at a time with Whelm. As an action, a creature within 5 feet of the elemental can pull a creature out of it by succeeding on a DC 14 Strength ([Athletics](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/2-tooltip?disable-webm=1&disable-webm=1")) check. *Success:* Half damage only.
...
**Senses** [Blindsight](/sources/dnd/free-rules/rules-glossary#Blindsight "//www.dndbeyond.com/senses/1-tooltip?disable-webm=1&disable-webm=1") 30 ft.; Passive Perception 10
...
***Invisible in Water.*** The water weird has the [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") condition while fully immersed in water.

***Water Bound.*** The water weird dies if it leaves the water to which it is bound or if that water is destroyed.

Actions

***Surge.*** *Melee Attack Roll:* +5, reach 10 ft. *Hit:* 13 (3d6 + 3) Cold damage. If the target is a Medium or smaller creature, it has the [Grappled](/sources/dnd/free-rules/rules-glossary#GrappledCondition "//www.dndbeyond.com/conditions/6-tooltip?disable-webm=1&disable-webm=1") condition (escape DC 13), and it has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition until the grapple ends.
...
**Gear** [Handaxes](/equipment/7-handaxe "//www.dndbeyond.com/weapons/7-tooltip?disable-webm=1&disable-webm=1") (4)
...
**Gear** [Javelins](/equipment/8-javelin "//www.dndbeyond.com/weapons/8-tooltip?disable-webm=1&disable-webm=1") (6)
...
***Tusk (Boar or Hybrid Form Only).*** *Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Piercing damage. If the target is a Medium or smaller creature and the wereboar moved 20+ feet straight toward it immediately before the hit, the target takes an extra 7 (2d6) Piercing damage and has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition.

Bonus Actions

***Shape-Shift.*** The wereboar [shape-shifts](/sources/dnd/free-rules/rules-glossary#ShapeShifting "//www.dndbeyond.com/rules-glossary/100-tooltip?disable-webm=1&disable-webm=1") into a Medium boar-humanoid hybrid or a Small boar, or it returns to its true humanoid form. Its game statistics, other than its size, are the same in each form. Any equipment it is wearing or carrying isn’t transformed.

Slawomir Maniak [![](https://media.dndbeyond.com/compendium-images/mm/hAxSwXnO1TSUruhZ/23-004.were-creature-group.png)](https://media.dndbeyond.com/compendium-images/mm/hAxSwXnO1TSUruhZ/23-004.were-creature-group.png)
...
**Gear** [Hand Crossbow](/equipment/1-crossbow-hand "//www.dndbeyond.com/weapons/1-tooltip?disable-webm=1&disable-webm=1")
...
***Shape-Shift.*** The wererat [shape-shifts](/sources/dnd/free-rules/rules-glossary#ShapeShifting "//www.dndbeyond.com/rules-glossary/100-tooltip?disable-webm=1&disable-webm=1") into a Medium rat-humanoid hybrid or a Small rat, or it returns to its true humanoid form. Its game statistics, other than its size, are the same in each form. Any equipment it is wearing or carrying isn’t transformed.
...
**Gear** [Longbow](/equipment/37-longbow "//www.dndbeyond.com/weapons/37-tooltip?disable-webm=1&disable-webm=1")
...
***Shape-Shift.*** The werewolf [shape-shifts](/sources/dnd/free-rules/rules-glossary#ShapeShifting "//www.dndbeyond.com/rules-glossary/100-tooltip?disable-webm=1&disable-webm=1") into a Large wolf-humanoid hybrid or a Medium wolf, or it returns to its true humanoid form. Its game statistics, other than its size, are the same in each form. Any equipment it is wearing or carrying isn’t transformed.
...
***Ice Walk.*** The dragon can move across and climb icy surfaces without needing to make an ability check. Additionally, [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1") composed of ice or snow doesn’t cost it extra movement.
...
***Cold Breath (Recharge 5–6).*** *Constitution Saving Throw:* DC 12, each creature in a 15-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). *Failure:* 22 (5d8) Cold damage. *Success:* Half damage.
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +6, [Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1") +3

**Immunities** Cold

**Senses** [Blindsight](/sources/dnd/free-rules/rules-glossary#Blindsight "//www.dndbeyond.com/senses/1-tooltip?disable-webm=1&disable-webm=1") 30 ft., [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") 120 ft.; Passive Perception 16
...
***Cold Breath (Recharge 5–6).*** *Constitution Saving Throw:* DC 15, each creature in a 30-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). *Failure:* 40 (9d8) Cold damage. *Success:* Half damage.
...
**Frigid Cold.** The area within 1 mile of the lair is an area of extreme cold. Any water in that area is frigid water. See the [Dungeon Master’s Guide](/sources/dnd/dmg-2024) for rules on [extreme cold](/sources/dnd/dmg-2024/dms-toolbox#ExtremeCold) and [frigid water](/sources/dnd/dmg-2024/dms-toolbox#FrigidWater).

**Glacial Gloom.** The area within 1 mile of the lair is [Lightly Obscured](/sources/dnd/free-rules/rules-glossary#LightlyObscured "//www.dndbeyond.com/rules-glossary/79-tooltip?disable-webm=1&disable-webm=1") by chilly fog. Whenever a creature other than the dragon or one of its allies finishes a Long Rest in that area, that creature must succeed on a DC 15 Constitution saving throw or have its Speed reduced by 10 feet for 1 hour.
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +11, [Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1") +5
...
***Cold Breath (Recharge 5–6).*** *Constitution Saving Throw:* DC 19, each creature in a 60-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). *Failure:* 54 (12d8) Cold damage. *Success:* Half damage.

Legendary Actions

Legendary Action Uses: 3 (4 in Lair). Immediately after another creature’s turn, the dragon can expend a use to take one of the following actions. The dragon regains all expended uses at the start of each of its turns.

***Freezing Burst.*** *Constitution Saving Throw:* DC 14, each creature in a 30-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point the dragon can see within 120 feet. *Failure:* 7 (2d6) Cold damage, and the target’s Speed is 0 until the end of the target’s next turn. *Failure or Success:* The dragon can’t take this action again until the start of its next turn.

***Frightful Presence.*** The dragon casts [Fear](/spells/2618872-fear "//www.dndbeyond.com/spells/2618872-tooltip?disable-webm=1&disable-webm=1"), requiring no Material components and using Charisma as the spellcasting ability (spell save DC 14). The dragon can’t take this action again until the start of its next turn.
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +13, [Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1") +6

**Immunities** Cold

**Senses** [Blindsight](/sources/dnd/free-rules/rules-glossary#Blindsight "//www.dndbeyond.com/senses/1-tooltip?disable-webm=1&disable-webm=1") 60 ft., [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") 120 ft.; Passive Perception 23
...
***Cold Breath (Recharge 5–6).*** *Constitution Saving Throw:* DC 22, each creature in a 90-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). *Failure:* 63 (14d8) Cold damage. *Success:* Half damage.

Legendary Actions

Legendary Action Uses: 3 (4 in Lair). Immediately after another creature’s turn, the dragon can expend a use to take one of the following actions. The dragon regains all expended uses at the start of each of its turns.

***Freezing Burst.*** *Constitution Saving Throw:* DC 20, each creature in a 30-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point the dragon can see within 120 feet. *Failure:* 14 (4d6) Cold damage, and the target’s Speed is 0 until the end of the target’s next turn. *Failure or Success:* The dragon can’t take this action again until the start of its next turn.
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +3, [Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1") +4
...
**Senses** [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") 60 ft.; Passive Perception 13
...
A Humanoid slain by this attack rises 24 hours later as a [Zombie](/monsters/4775851-zombie "//www.dndbeyond.com/monsters/4775851-tooltip?disable-webm=1&disable-webm=1") under the wight’s control, unless the Humanoid is restored to life or its body is destroyed. The wight can have no more than twelve zombies under its control at a time.
...
| 2 | An ambush by hungry [ghouls](/monsters/5195009-ghoul "//www.dndbeyond.com/monsters/5195009-tooltip?disable-webm=1&disable-webm=1") or [vampires](/monsters/5195251-vampire "//www.dndbeyond.com/monsters/5195251-tooltip?disable-webm=1&disable-webm=1"). |
| 3 | A dreaded ruin that curses those who enter. |
| 4 | The lair of a predator, like a bear or [wyvern](/monsters/5195273-wyvern "//www.dndbeyond.com/monsters/5195273-tooltip?disable-webm=1&disable-webm=1"). |
| 5 | Patches of [brown mold](/sources/dnd/dmg-2024/dms-toolbox#BrownMold)\* or [green slime](/sources/dnd/dmg-2024/dms-toolbox#GreenSlime).\* |
| 6 | [Quicksand](/sources/dnd/dmg-2024/dms-toolbox#QuicksandPit)\* or pools covered in [thin ice](/sources/dnd/dmg-2024/dms-toolbox#ThinIce).\* |
| \*See the [Dungeon Master’s Guide](/sources/dnd/dmg-2024). |
...
**Immunities** Lightning, Poison; [Exhaustion](/sources/dnd/free-rules/rules-glossary#ExhaustionCondition "//www.dndbeyond.com/conditions/4-tooltip?disable-webm=1&disable-webm=1"), [Grappled](/sources/dnd/free-rules/rules-glossary#GrappledCondition "//www.dndbeyond.com/conditions/6-tooltip?disable-webm=1&disable-webm=1"), [Paralyzed](/sources/dnd/free-rules/rules-glossary#ParalyzedCondition "//www.dndbeyond.com/conditions/9-tooltip?disable-webm=1&disable-webm=1"), [Petrified](/sources/dnd/free-rules/rules-glossary#PetrifiedCondition "//www.dndbeyond.com/conditions/10-tooltip?disable-webm=1&disable-webm=1"), [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1"), [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1"), [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1"), [Unconscious](/sources/dnd/free-rules/rules-glossary#UnconsciousCondition "//www.dndbeyond.com/conditions/15-tooltip?disable-webm=1&disable-webm=1")
...
Winter wolves are more intelligent than natural [wolves](/monsters/4775850-wolf "//www.dndbeyond.com/monsters/4775850-tooltip?disable-webm=1&disable-webm=1") and can speak. Most are predominantly concerned with their next meal, and while they might converse with other creatures in exchange for food, few concern themselves with long-term bargains or keeping their word unless they have something to gain. Winter wolves often hunt alongside [frost giants](/monsters/5195001-frost-giant "//www.dndbeyond.com/monsters/5195001-tooltip?disable-webm=1&disable-webm=1") that indulge them with frequent hunts and reliable meals.
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +5, [Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1") +5
...
***Bite.*** *Melee Attack Roll:* +6, reach 5 ft. *Hit:* 11 (2d6 + 4) Piercing damage. If the target is a Large or smaller creature, it has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition.

***Cold Breath (Recharge 5–6).*** *Constitution Saving Throw:* DC 12, each creature in a 15-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). *Failure:* 18 (4d8) Cold damage. *Success:* Half damage.
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +4
...
Dire worgs are larger than common worgs and possess a supernaturally terrifying howl. They frequently hunt alongside [ettins](/monsters/5194990-ettin "//www.dndbeyond.com/monsters/5194990-tooltip?disable-webm=1&disable-webm=1"), [ogres](/monsters/4904825-ogre "//www.dndbeyond.com/monsters/4904825-tooltip?disable-webm=1&disable-webm=1"), and [trolls](/monsters/5195241-troll "//www.dndbeyond.com/monsters/5195241-tooltip?disable-webm=1&disable-webm=1").
...
**Skills** [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") +11

**Senses** [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") 120 ft.; Passive Perception 21
...
***Dreadful Howl (Recharge 5–6).*** *Wisdom Saving Throw:* DC 16, each creature within 30 feet that isn’t a worg. *Failure:* 36 (8d8) Psychic damage, and the target has the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition until the start of the worg’s next turn. *Success:* Half damage only.
...
| 10 | The voracity of a life-hungry realm, such as the [Shadowfell](/sources/dnd/dmg-2024/cosmology#Shadowfell "//www.dndbeyond.com/lore-glossary/301-tooltip?disable-webm=1&disable-webm=1") or [Negative Plane](/sources/dnd/dmg-2024/cosmology#NegativePlane "//www.dndbeyond.com/lore-glossary/276-tooltip?disable-webm=1&disable-webm=1"). |
...
***Create Specter.*** The wraith targets a Humanoid corpse within 10 feet of itself that has been dead for no longer than 1 minute. The target’s spirit rises as a [Specter](/monsters/5195210-specter "//www.dndbeyond.com/monsters/5195210-tooltip?disable-webm=1&disable-webm=1") in the space of its corpse or in the nearest unoccupied space. The specter is under the wraith’s control. The wraith can have no more than seven specters under its control at a time.
...
**Senses** [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") 120 ft.; Passive Perception 14
...
*Source: https://www.dndbeyond.com/sources/dnd/mm-2024/monsters-w*