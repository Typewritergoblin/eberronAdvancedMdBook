# Spell Descriptions - Player’s Handbook - Dungeons & Dragons - Sources - D&D Beyond
...
[Appendix A: The Multiverse](./the-multiverse)
...
You create an acidic bubble at a point within range, where it explodes in a 5-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1"). Each creature in that Sphere must succeed on a Dexterity saving throw or take 1d6 Acid damage.
...
**Duration:** [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), up to 1 hour

You alter your physical form. Choose one of the following options. Its effects last for the duration, during which you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to replace the option you chose with a different one.

***Aquatic Adaptation.*** You sprout gills and grow webs between your fingers. You can breathe underwater and gain a Swim Speed equal to your Speed.

***Change Appearance.*** You alter your appearance. You decide what you look like, including your height, weight, facial features, sound of your voice, hair length, coloration, and other distinguishing characteristics. You can make yourself appear as a member of another species, though none of your statistics change. You can’t appear as a creature of a different size, and your basic shape stays the same; if you’re bipedal, you can’t use this spell to become quadrupedal, for instance. For the duration, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to change your appearance in this way again.

***Natural Weapons.*** You grow claws (Slashing), fangs (Piercing), horns (Piercing), or hooves (Bludgeoning). When you use your [Unarmed Strike](/sources/dnd/free-rules/rules-glossary#UnarmedStrike "//www.dndbeyond.com/rules-glossary/120-tooltip?disable-webm=1&disable-webm=1") to deal damage with that new growth, it deals 1d6 damage of the type in parentheses instead of dealing the normal damage for your Unarmed Strike, and you use your spellcasting ability modifier for the attack and damage rolls rather than using Strength.
...
**Duration:** [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), up to 1 minute
...
An aura extends from you in a 10-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. The aura prevents creatures other than Constructs and Undead from passing or reaching through it. An affected creature can cast spells or make attacks with Ranged or Reach weapons through the barrier.
...
An aura of antimagic surrounds you in 10-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1"). No one can cast spells, take [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") actions, or create other magical effects inside the aura, and those things can’t target or otherwise affect anything inside it. Magical properties of magic items don’t work inside the aura or on anything inside it.

Areas of effect created by spells or other magic can’t extend into the aura, and no one can teleport into or out of it or use planar travel there. Portals close temporarily while in the aura.

Ongoing spells, except those cast by an Artifact or a deity, are suppressed in the area. While an effect is suppressed, it doesn’t function, but the time it spends suppressed counts against its duration.

[Dispel Magic](/spells/2619103-dispel-magic "//www.dndbeyond.com/spells/2619103-tooltip?disable-webm=1&disable-webm=1") has no effect on the aura, and the auras created by different *Antimagic Field* spells don’t nullify each other.
...
**Duration:** [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), up to 10 minutes
...
Protective magical frost surrounds you. You gain 5 [Temporary Hit Points](/sources/dnd/free-rules/rules-glossary#TemporaryHitPoints "//www.dndbeyond.com/rules-glossary/119-tooltip?disable-webm=1&disable-webm=1"). If a creature hits you with a melee attack roll before the spell ends, the creature takes 5 Cold damage. The spell ends early if you have no Temporary Hit Points.
...
Invoking Hadar, you cause tendrils to erupt from yourself. Each creature in a 10-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") originating from you makes a Strength saving throw. On a failed save, a target takes 2d6 Necrotic damage and can’t take Reactions until the start of its next turn. On a successful save, a target takes half as much damage only.
...
If you cast the spell more than once before finishing a [Long Rest](/sources/dnd/free-rules/rules-glossary#LongRest "//www.dndbeyond.com/rules-glossary/82-tooltip?disable-webm=1&disable-webm=1"), there is a cumulative 25 percent chance for each casting after the first that you get no answer.
...
An aura radiates from you in a 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. While in the aura, you and your allies have Resistance to Necrotic damage, and your Hit Point maximums can’t be reduced. If an ally with 0 Hit Points starts its turn in the aura, that ally regains 1 Hit Point.
...
An aura radiates from you in a 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. When you create the aura and at the start of each of your turns while it persists, you can restore 2d6 Hit Points to one creature in it.
...
Choose any number of creatures within range. For the duration, each target has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on Wisdom saving throws and Death Saving Throws and regains the maximum number of Hit Points possible from any healing.
...
On a failed save, the target takes 10d12 Psychic damage and can’t cast spells or take the [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action. At the end of every 30 days, the target repeats the save, ending the effect on a success. The effect can also be ended by the [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1"), [Heal](/spells/2618979-heal "//www.dndbeyond.com/spells/2618979-tooltip?disable-webm=1&disable-webm=1"), or [Wish](/spells/2619213-wish "//www.dndbeyond.com/spells/2619213-tooltip?disable-webm=1&disable-webm=1") spell.
...
-   Choose one ability. The target has [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on ability checks and saving throws made with that ability.
-   The target has Disadvantage on attack rolls against you.
-   In combat, the target must succeed on a Wisdom saving throw at the start of each of its turns or be forced to take the [Dodge](/sources/dnd/free-rules/rules-glossary#DodgeAction "//www.dndbeyond.com/actions/6-tooltip?disable-webm=1&disable-webm=1") action on that turn.
-   If you deal damage to the target with an attack roll or a spell, the target takes an extra 1d8 Necrotic damage.

***Using a Higher-Level Spell Slot.*** If you cast this spell using a level 4 spell slot, you can maintain [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1") on it for up to 10 minutes. If you use a level 5+ spell slot, the spell doesn’t require Concentration, and the duration becomes 8 hours (level 5–6 slot) or 24 hours (level 7–8 slot). If you use a level 9 spell slot, the spell lasts until dispelled.
...
Your body becomes blurred. For the duration, any creature has [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on attack rolls against you. An attacker is immune to this effect if it perceives you with [Blindsight](/sources/dnd/free-rules/rules-glossary#Blindsight "//www.dndbeyond.com/senses/1-tooltip?disable-webm=1&disable-webm=1") or [Truesight](/sources/dnd/free-rules/rules-glossary#Truesight "//www.dndbeyond.com/senses/4-tooltip?disable-webm=1&disable-webm=1").
...
A thin sheet of flames shoots forth from you. Each creature in a 15-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1") makes a Dexterity saving throw, taking 3d6 Fire damage on a failed save or half as much damage on a successful one.

Flammable objects in the Cone that aren’t being worn or carried start [burning](/sources/dnd/free-rules/rules-glossary#BurningHazard "//www.dndbeyond.com/rules-glossary/22-tooltip?disable-webm=1&disable-webm=1").
...
A storm cloud appears at a point within range that you can see above yourself. It takes the shape of a [Cylinder](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect "//www.dndbeyond.com/rules-glossary/40-tooltip?disable-webm=1&disable-webm=1") that is 10 feet tall with a 60-foot radius.
...
Until the spell ends, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to call down lightning in that way again, targeting the same point or a different one.
...
Each Humanoid in a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point you choose within range must succeed on a Charisma saving throw or be affected by one of the following effects (choose for each creature):

-   The creature has Immunity to the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") and [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") conditions until the spell ends. If the creature was already Charmed or Frightened, those conditions are suppressed for the duration.
-   The creature becomes [Indifferent](/sources/dnd/free-rules/rules-glossary#IndifferentAttitude "//www.dndbeyond.com/rules-glossary/75-tooltip?disable-webm=1&disable-webm=1") about creatures of your choice that it’s [Hostile](/sources/dnd/free-rules/rules-glossary#HostileAttitude "//www.dndbeyond.com/rules-glossary/70-tooltip?disable-webm=1&disable-webm=1") toward. This indifference ends if the target takes damage or witnesses its allies taking damage. When the spell ends, the creature’s attitude returns to normal.
...
One creature you can see within range makes a Wisdom saving throw. It does so with [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") if you or your allies are fighting it. On a failed save, the target has the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition until the spell ends or until you or your allies damage it. The Charmed creature is [Friendly](/sources/dnd/free-rules/rules-glossary#FriendlyAttitude "//www.dndbeyond.com/rules-glossary/62-tooltip?disable-webm=1&disable-webm=1") to you. When the spell ends, the target knows it was Charmed by you.
...
Negative energy ripples out in a 60-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") from a point you choose within range. Each creature in that area makes a Constitution saving throw, taking 8d8 Necrotic damage on a failed save or half as much damage on a successful one.
...
An aura radiates from you in a 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. While in the aura, you and your allies have [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on saving throws against spells and other magical effects. When an affected creature makes a saving throw against a spell or magical effect that allows a save to take only half damage, it takes no damage if it succeeds on the save.
...
You create an [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") sensor within range in a location familiar to you (a place you have visited or seen before) or in an obvious location that is unfamiliar to you (such as behind a door, around a corner, or in a grove of trees). The intangible, invulnerable sensor remains in place for the duration.
...
You create a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") of yellow-green fog centered on a point within range. The fog lasts for the duration or until strong wind (such as the one created by [Gust of Wind](/spells/2619137-gust-of-wind "//www.dndbeyond.com/spells/2619137-tooltip?disable-webm=1&disable-webm=1")) disperses it, ending the spell. Its area is [Heavily Obscured](/sources/dnd/free-rules/rules-glossary#HeavilyObscured "//www.dndbeyond.com/rules-glossary/65-tooltip?disable-webm=1&disable-webm=1").
...
You conjure spinning daggers in a 5-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") centered on a point within range. Each creature in that area takes 4d4 Slashing damage. A creature also takes this damage if it enters the Cube or ends its turn there or if the Cube moves into its space. A creature takes this damage only once per turn.

On your later turns, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to teleport the Cube up to 30 feet.
...
You launch a dazzling array of flashing, colorful light. Each creature in a 15-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1") originating from you must succeed on a Constitution saving throw or have the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition until the end of your next turn.
...
**Grovel.** The target has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition and then ends its turn.
...
Each creature of your choice that you can see within range must succeed on a Wisdom saving throw or have the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition until the spell ends.
...
You unleash a blast of cold air. Each creature in a 60-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1") originating from you makes a Constitution saving throw, taking 8d8 Cold damage on a failed save or half as much damage on a successful one. A creature killed by this spell becomes a frozen statue until it thaws.
...
Each creature in a 10-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point you choose within range must succeed on a Wisdom saving throw, or that target can’t take Bonus Actions or Reactions and must roll 1d10 at the start of each of its turns to determine its behavior for that turn, consulting the table below.
...
| 7–8 | The target doesn’t move, and it takes the [Attack](/sources/dnd/free-rules/rules-glossary#AttackAction "//www.dndbeyond.com/actions/1-tooltip?disable-webm=1&disable-webm=1") action to make one melee attack against a random creature within reach. If none are within reach, the target takes no action. |
...
You have [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on Strength saving throws while you’re within 5 feet of the pack, and when you move on your turn, you can also move the pack up to 30 feet to an unoccupied space you can see.
...
Until the spell ends, [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") fills the Cylinder, and when you move on your turn, you can also move the Cylinder up to 30 feet.
...
You conjure spirits from the Elemental Planes that flit around you in a 15-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. Until the spell ends, any attack you make deals an extra 2d8 damage when you hit a creature in the Emanation. This damage is Acid, Cold, Fire, or Lightning (your choice when you make the attack).

In addition, the ground in the Emanation is [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1") for your enemies.
...
You conjure nature spirits that flit around you in a 10-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. Whenever the Emanation enters the space of a creature you can see and whenever a creature you can see enters the Emanation or ends its turn there, you can force that creature to make a Wisdom saving throw. The creature takes 5d8 Force damage on a failed save or half as much damage on a successful one. A creature makes this save only once per turn.

In addition, you can take the [Disengage](/sources/dnd/free-rules/rules-glossary#DisengageAction "//www.dndbeyond.com/actions/5-tooltip?disable-webm=1&disable-webm=1") action as a Bonus Action for the spell’s duration.
...
On a failed save, you take 6d6 Psychic damage and have the [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") condition until you finish a [Long Rest](/sources/dnd/free-rules/rules-glossary#LongRest "//www.dndbeyond.com/rules-glossary/82-tooltip?disable-webm=1&disable-webm=1"). A [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1") spell cast on you ends this effect.
...
Your touch inflicts a magical contagion. The target must succeed on a Constitution saving throw or take 11d8 Necrotic damage and have the [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1") condition. Also, choose one ability when you cast the spell. While Poisoned, the target has [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on saving throws made with the chosen ability.
...
Until the spell ends, you control any water inside an area you choose that is a [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") up to 100 feet on a side, using one of the following effects. As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action on your later turns, you can repeat the same effect or choose a different one.
...
**Duration:** [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), up to 8 hours
...
You touch up to four nonmagical [Arrows](/equipment/508-arrows "//www.dndbeyond.com/adventuring-gear/508-tooltip?disable-webm=1&disable-webm=1") or [Bolts](/equipment/510-bolts "//www.dndbeyond.com/adventuring-gear/510-tooltip?disable-webm=1&disable-webm=1") and plant them in the ground in your space. Until the spell ends, the ammunition can’t be physically uprooted, and whenever a creature other than you enters a space within 30 feet of the ammunition for the first time on a turn or ends its turn there, one piece of ammunition flies up to strike it. The creature must succeed on a Dexterity saving throw or take 2d4 Piercing damage. The piece of ammunition is then destroyed. The spell ends when none of the ammunition remains planted in the ground.
...
You create 45 pounds of food and 30 gallons of fresh water on the ground or in containers within range—both useful in fending off the hazards of [malnutrition](/sources/dnd/free-rules/rules-glossary#MalnutritionHazard "//www.dndbeyond.com/rules-glossary/84-tooltip?disable-webm=1&disable-webm=1") and [dehydration](/sources/dnd/free-rules/rules-glossary#DehydrationHazard "//www.dndbeyond.com/rules-glossary/49-tooltip?disable-webm=1&disable-webm=1"). The food is bland but nourishing and looks like a food of your choice, and the water is clean. The food spoils after 24 hours if uneaten.
...
**Create Water.** You create up to 10 gallons of clean water within range in an open container. Alternatively, the water falls as rain in a 30-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") within range, extinguishing exposed flames there.
...
You can cast this spell only at night. Choose up to three corpses of Medium or Small Humanoids within range. Each one becomes a [Ghoul](/monsters/5195009-ghoul "//www.dndbeyond.com/monsters/5195009-tooltip?disable-webm=1&disable-webm=1") under your control (see the [Monster Manual](/sources/dnd/mm-2024) for its stat block).
...
***Using a Higher-Level Spell Slot.*** If you use a level 7 spell slot, you can animate or reassert control over four [Ghouls](/monsters/5195009-ghoul "//www.dndbeyond.com/monsters/5195009-tooltip?disable-webm=1&disable-webm=1"). If you use a level 8 spell slot, you can animate or reassert control over five [Ghouls](/monsters/5195009-ghoul "//www.dndbeyond.com/monsters/5195009-tooltip?disable-webm=1&disable-webm=1") or two [Ghasts](/monsters/5195007-ghast "//www.dndbeyond.com/monsters/5195007-tooltip?disable-webm=1&disable-webm=1") or [Wights](/monsters/5195269-wight "//www.dndbeyond.com/monsters/5195269-tooltip?disable-webm=1&disable-webm=1"). If you use a level 9 spell slot, you can animate or reassert control over six [Ghouls](/monsters/5195009-ghoul "//www.dndbeyond.com/monsters/5195009-tooltip?disable-webm=1&disable-webm=1"), three [Ghasts](/monsters/5195007-ghast "//www.dndbeyond.com/monsters/5195007-tooltip?disable-webm=1&disable-webm=1") or [Wights](/monsters/5195269-wight "//www.dndbeyond.com/monsters/5195269-tooltip?disable-webm=1&disable-webm=1"), or two [Mummies](/monsters/5195135-mummy "//www.dndbeyond.com/monsters/5195135-tooltip?disable-webm=1&disable-webm=1"). See the [Monster Manual](/sources/dnd/mm-2024) for these stat blocks.
...
One creature that you can see within range must succeed on a Wisdom saving throw or have the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition for the duration. The creature succeeds automatically if it isn’t Humanoid.
...
On your later turns, you must take the [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to maintain control of the target, or the spell ends.
...
You radiate a magical aura in a 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1"). While in the aura, you and your allies each deal an extra 1d4 Radiant damage when hitting with a weapon or an Unarmed Strike.
...
For the duration, a willing creature you touch has [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") with a range of 150 feet.
...
For the duration, sunlight spreads from a point within range and fills a 60-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1"). The sunlight’s area is [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") and sheds [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") for an additional 60 feet.
...
If any of this spell’s area overlaps with an area of [Darkness](/sources/dnd/free-rules/rules-glossary#Darkness "//www.dndbeyond.com/rules-glossary/46-tooltip?disable-webm=1&disable-webm=1") created by a spell of level 3 or lower, that other spell is dispelled.
...
When the bead explodes, flammable objects in the explosion that aren’t being worn or carried start [burning](/sources/dnd/free-rules/rules-glossary#BurningHazard "//www.dndbeyond.com/rules-glossary/22-tooltip?disable-webm=1&disable-webm=1").
...
Destructive energy ripples outward from you in a 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1"). Each creature you choose in the Emanation makes a Constitution saving throw. On a failed save, a target takes 5d6 Thunder damage and 5d6 Radiant or Necrotic damage (your choice) and has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition. On a successful save, a target takes half as much damage only.
...
For the duration, you sense the location of any Aberration, Celestial, Elemental, Fey, Fiend, or Undead within 30 feet of yourself. You also sense whether the [Hallow](/spells/2619138-hallow "//www.dndbeyond.com/spells/2619138-tooltip?disable-webm=1&disable-webm=1") spell is active there and, if so, where.
...
You activate one of the effects below. Until the spell ends, you can activate either effect as a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action on your later turns.
...
As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action on your next turn, you can try to probe deeper into the target’s mind. If you probe deeper, the target makes a Wisdom saving throw. On a failed save, you discern the target’s reasoning, emotions, and something that looms large in its mind (such as a worry, love, or hate). On a successful save, the spell ends. Either way, the target knows that you are probing into its mind, and until you shift your attention away from the target’s mind, the target can take an action on its turn to make an Intelligence ([Arcana](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/6-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC, ending the spell on a success.
...
To discern that you are disguised, a creature must take the [Study](/sources/dnd/free-rules/rules-glossary#StudyAction "//www.dndbeyond.com/actions/1007-tooltip?disable-webm=1&disable-webm=1") action to inspect your appearance and succeed on an Intelligence ([Investigation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/8-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC.
...
You launch a green ray at a target you can see within range. The target can be a creature, a nonmagical object, or a creation of magical force, such as the wall created by [Wall of Force](/spells/2619194-wall-of-force "//www.dndbeyond.com/spells/2619194-tooltip?disable-webm=1&disable-webm=1").

A creature targeted by this spell makes a Dexterity saving throw. On a failed save, the target takes 10d6 + 40 Force damage. If this damage reduces it to 0 Hit Points, it and everything nonmagical it is wearing and carrying are disintegrated into gray dust. The target can be revived only by a [True Resurrection](/spells/2619199-true-resurrection "//www.dndbeyond.com/spells/2619199-tooltip?disable-webm=1&disable-webm=1") or a [Wish](/spells/2619213-wish "//www.dndbeyond.com/spells/2619213-tooltip?disable-webm=1&disable-webm=1") spell.

This spell automatically disintegrates a Large or smaller nonmagical object or a creation of magical force. If such a target is Huge or larger, this spell disintegrates a 10-foot-[Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") portion of it.
...
For the duration, Celestials, Elementals, Fey, Fiends, and Undead have [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on attack rolls against you. You can end the spell early by using either of the following special functions.

***Break Enchantment.*** As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, you touch a creature that is [possessed](/sources/dnd/free-rules/rules-glossary#Possession "//www.dndbeyond.com/rules-glossary/92-tooltip?disable-webm=1&disable-webm=1") by or has the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") or [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition from one or more creatures of the types above. The target is no longer possessed, Charmed, or Frightened by such creatures.

***Dismissal.*** As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, you target one creature you can see within 5 feet of you that has one of the creature types above. The target must succeed on a Charisma saving throw or be sent back to its home plane if it isn’t there already. If they aren’t on their home plane, Undead are sent to the Shadowfell, and Fey are sent to the Feywild.
...
You utter a word imbued with power from the Upper Planes. Each creature of your choice in range makes a Charisma saving throw. On a failed save, a target that has 50 Hit Points or fewer suffers an effect based on its current Hit Points, as shown in the Divine Word Effects table. Regardless of its Hit Points, a Celestial, an Elemental, a Fey, or a Fiend target that fails its save is forced back to its plane of origin (if it isn’t there already) and can’t return to the current plane for 24 hours by any means short of a [Wish](/spells/2619213-wish "//www.dndbeyond.com/spells/2619213-tooltip?disable-webm=1&disable-webm=1") spell.

Divine Word Effects
| Hit Points | Effect |
| --- | --- |
| 0–20 | The target dies. |
| 21–30 | The target has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1"), [Deafened](/sources/dnd/free-rules/rules-glossary#DeafenedCondition "//www.dndbeyond.com/conditions/3-tooltip?disable-webm=1&disable-webm=1"), and [Stunned](/sources/dnd/free-rules/rules-glossary#StunnedCondition "//www.dndbeyond.com/conditions/14-tooltip?disable-webm=1&disable-webm=1") conditions for 1 hour. |
| 31–40 | The target has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") and [Deafened](/sources/dnd/free-rules/rules-glossary#DeafenedCondition "//www.dndbeyond.com/conditions/3-tooltip?disable-webm=1&disable-webm=1") conditions for 10 minutes. |
| 41–50 | The target has the [Deafened](/sources/dnd/free-rules/rules-glossary#DeafenedCondition "//www.dndbeyond.com/conditions/3-tooltip?disable-webm=1&disable-webm=1") condition for 1 minute. |
...
One Beast you can see within range must succeed on a Wisdom saving throw or have the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition for the duration. The target has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on the save if you or your allies are fighting it. Whenever the target takes damage, it repeats the save, ending the spell on itself on a success.

You have a telepathic link with the Charmed target while the two of you are on the same plane of existence. On your turn, you can use this link to issue commands to the target (no action required), such as “Attack that creature,” “Move over there,” or “Fetch that object.” The target does its best to obey on its turn. If it completes an order and doesn’t receive further direction from you, it acts and moves as it likes, focusing on protecting itself.

You can command the target to take a Reaction but must take your own Reaction to do so.

***Using a Higher-Level Spell Slot.*** Your [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1") can last longer with a spell slot of level 5 (up to 10 minutes), 6 (up to 1 hour), or 7+ (up to 8 hours).
...
***Using a Higher-Level Spell Slot.*** Your [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1") can last longer with a level 9 spell slot (up to 8 hours).
...
***Using a Higher-Level Spell Slot.*** Your [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1") can last longer with a spell slot of level 6 (up to 10 minutes), 7 (up to 1 hour), or 8+ (up to 8 hours).
...
You target a creature you know on the same plane of existence. You or a willing creature you touch enters a trance state to act as a dream messenger. While in the trance, the messenger is [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") and has a Speed of 0.
...
***Beckon Air.*** You create a breeze strong enough to ripple cloth, stir dust, rustle leaves, and close open doors and shutters, all in a 5-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1"). Doors and shutters being held open by someone or something aren’t affected.

***Beckon Earth.*** You create a thin shroud of dust or sand that covers surfaces in a 5-foot-square area, or you cause a single word to appear in your handwriting in a patch of dirt or sand.

***Beckon Fire.*** You create a thin cloud of harmless embers and colored, scented smoke in a 5-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1"). You choose the color and scent, and the embers can light candles, torches, or lamps in that area. The smoke’s scent lingers for 1 minute.

***Beckon Water.*** You create a spray of cool mist that lightly dampens creatures and objects in a 5-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1"). Alternatively, you create 1 cup of clean water either in an open container or on a surface, and the water evaporates in 1 minute.

***Sculpt Element.*** You cause dirt, sand, fire, smoke, mist, or water that can fit in a 1-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") to assume a crude shape (such as that of a creature) for 1 hour.
...
You touch a creature and choose Strength, Dexterity, Intelligence, Wisdom, or Charisma. For the duration, the target has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on ability checks using the chosen ability.
...
As you hit the target, grasping vines appear on it, and it makes a Strength saving throw. A Large or larger creature has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on this save. On a failed save, the target has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition until the spell ends. On a successful save, the vines shrivel away, and the spell ends.

While Restrained, the target takes 1d6 Piercing damage at the start of each of its turns. The target or a creature within reach of it can take an action to make a Strength ([Athletics](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/2-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC. On a success, the spell ends.
...
Squirming, ebony tentacles fill a 20-foot square on ground that you can see within range. For the duration, these tentacles turn the ground in that area into [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1").

Each creature in that area makes a Strength saving throw. On a failed save, it takes 3d6 Bludgeoning damage, and it has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition until the spell ends. A creature also makes that save if it enters the area or ends it turn there. A creature makes that save only once per turn.

A Restrained creature can take an action to make a Strength ([Athletics](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/2-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC, ending the condition on itself on a success.
...
You take the [Dash](/sources/dnd/free-rules/rules-glossary#DashAction "//www.dndbeyond.com/actions/4-tooltip?disable-webm=1&disable-webm=1") action, and until the spell ends, you can take that action again as a Bonus Action.
...
On each of your turns until the spell ends, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to target another creature but can’t target a creature again if it has succeeded on a save against this casting of the spell.

***Asleep.*** The target has the [Unconscious](/sources/dnd/free-rules/rules-glossary#UnconsciousCondition "//www.dndbeyond.com/conditions/15-tooltip?disable-webm=1&disable-webm=1") condition. It wakes up if it takes any damage or if another creature takes an action to shake it awake.

***Panicked.*** The target has the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition. On each of its turns, the Frightened target must take the [Dash](/sources/dnd/free-rules/rules-glossary#DashAction "//www.dndbeyond.com/actions/4-tooltip?disable-webm=1&disable-webm=1") action and move away from you by the safest and shortest route available. If the target moves to a space at least 60 feet away from you where it can’t see you, this effect ends.

***Sickened.*** The target has the [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1") condition.
...
Objects in a 20-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") within range are outlined in blue, green, or violet light (your choice). Each creature in the Cube is also outlined if it fails a Dexterity saving throw. For the duration, objects and affected creatures shed [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") in a 10-foot radius and can’t benefit from the [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") condition.

Attack rolls against an affected creature or object have [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") if the attacker can see it.
...
You gain 2d4 + 4 [Temporary Hit Points](/sources/dnd/free-rules/rules-glossary#TemporaryHitPoints "//www.dndbeyond.com/rules-glossary/119-tooltip?disable-webm=1&disable-webm=1").
...
Each creature in a 30-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1") must succeed on a Wisdom saving throw or drop whatever it is holding and have the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition for the duration.

A Frightened creature takes the [Dash](/sources/dnd/free-rules/rules-glossary#DashAction "//www.dndbeyond.com/actions/4-tooltip?disable-webm=1&disable-webm=1") action and moves away from you by the safest route on each of its turns unless there is nowhere to move. If the creature ends its turn in a space where it doesn’t have line of sight to you, the creature makes a Wisdom saving throw. On a successful save, the spell ends on that creature.
...
For the duration, the target appears dead to outward inspection and to spells used to determine the target’s status. The target has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") and [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") conditions, and its Speed is 0.

The target also has Resistance to all damage except Psychic damage, and it has Immunity to the [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1") condition.
...
You gain the service of a familiar, a spirit that takes an animal form you choose: [Bat](/monsters/4775803-bat "//www.dndbeyond.com/monsters/4775803-tooltip?disable-webm=1&disable-webm=1"), [Cat](/monsters/4775808-cat "//www.dndbeyond.com/monsters/4775808-tooltip?disable-webm=1&disable-webm=1"), [Frog](/monsters/4775816-frog "//www.dndbeyond.com/monsters/4775816-tooltip?disable-webm=1&disable-webm=1"), [Hawk](/monsters/4775824-hawk "//www.dndbeyond.com/monsters/4775824-tooltip?disable-webm=1&disable-webm=1"), [Lizard](/monsters/4775827-lizard "//www.dndbeyond.com/monsters/4775827-tooltip?disable-webm=1&disable-webm=1"), [Octopus](/monsters/4775830-octopus "//www.dndbeyond.com/monsters/4775830-tooltip?disable-webm=1&disable-webm=1"), [Owl](/monsters/4775831-owl "//www.dndbeyond.com/monsters/4775831-tooltip?disable-webm=1&disable-webm=1"), [Rat](/monsters/4775836-rat "//www.dndbeyond.com/monsters/4775836-tooltip?disable-webm=1&disable-webm=1"), [Raven](/monsters/4775837-raven "//www.dndbeyond.com/monsters/4775837-tooltip?disable-webm=1&disable-webm=1"), [Spider](/monsters/4775844-spider "//www.dndbeyond.com/monsters/4775844-tooltip?disable-webm=1&disable-webm=1"), [Weasel](/monsters/4775849-weasel "//www.dndbeyond.com/monsters/4775849-tooltip?disable-webm=1&disable-webm=1"), or another Beast that has a Challenge Rating of 0. Appearing in an unoccupied space within range, the familiar has the statistics of the chosen form (see [appendix B](/sources/dnd/phb-2024/creature-stat-blocks/)), though it is a Celestial, Fey, or Fiend (your choice) instead of a Beast. Your familiar acts independently of you, but it obeys your commands.
...
***Disappearance of the Familiar.*** When the familiar drops to 0 Hit Points, it disappears. It reappears after you cast this spell again. As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, you can temporarily dismiss the familiar to a pocket dimension. Alternatively, you can dismiss it forever. As a Magic action while it is temporarily dismissed, you can cause it to reappear in an unoccupied space within 30 feet of you. Whenever the familiar drops to 0 Hit Points or disappears into the pocket dimension, it leaves behind in its space anything it was wearing or carrying.
...
***Fell Glare (Fiend Only; Recharges after a [Long Rest](/sources/dnd/free-rules/rules-glossary#LongRest "//www.dndbeyond.com/rules-glossary/82-tooltip?disable-webm=1&disable-webm=1")).*** *Wisdom Saving Throw:* DC equals your spell save DC, one creature within 60 feet the steed can see. *Failure:* The target has the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition until the end of your next turn.

***Fey Step (Fey Only; Recharges after a [Long Rest](/sources/dnd/free-rules/rules-glossary#LongRest "//www.dndbeyond.com/rules-glossary/82-tooltip?disable-webm=1&disable-webm=1")).*** The steed teleports, along with its rider, to an unoccupied space of your choice up to 60 feet away from itself.

***Healing Touch (Celestial Only; Recharges after a [Long Rest](/sources/dnd/free-rules/rules-glossary#LongRest "//www.dndbeyond.com/rules-glossary/82-tooltip?disable-webm=1&disable-webm=1")).*** One creature within 5 feet of the steed regains a number of Hit Points equal to 2d8 plus the spell’s level.
...
**Duration:** [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), up to 1 day
...
You sense any trap within range that is within line of sight. A trap, for the purpose of this spell, includes any object or mechanism that was created to cause damage or other danger. Thus, the spell would sense the [Alarm](/spells/2619222-alarm "//www.dndbeyond.com/spells/2619222-tooltip?disable-webm=1&disable-webm=1") or [Glyph of Warding](/spells/2618951-glyph-of-warding "//www.dndbeyond.com/spells/2618951-tooltip?disable-webm=1&disable-webm=1") spell or a mechanical pit trap, but it wouldn’t reveal a natural weakness in the floor, an unstable ceiling, or a hidden sinkhole.
...
A Humanoid killed by this spell rises at the start of your next turn as a [Zombie](/monsters/4775851-zombie "//www.dndbeyond.com/monsters/4775851-tooltip?disable-webm=1&disable-webm=1") (see [appendix B](/sources/dnd/phb-2024/creature-stat-blocks#Zombie)) that follows your verbal orders.
...
Flammable objects in the area that aren’t being worn or carried start [burning](/sources/dnd/free-rules/rules-glossary#BurningHazard "//www.dndbeyond.com/rules-glossary/22-tooltip?disable-webm=1&disable-webm=1").
...
You hurl a mote of fire at a creature or an object within range. Make a ranged spell attack against the target. On a hit, the target takes 1d10 Fire damage. A flammable object hit by this spell starts [burning](/sources/dnd/free-rules/rules-glossary#BurningHazard "//www.dndbeyond.com/rules-glossary/22-tooltip?disable-webm=1&disable-webm=1") if it isn’t being worn or carried.
...
Wispy flames wreathe your body for the duration, shedding [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") in a 10-foot radius and [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") for an additional 10 feet.
...
As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, you can make a melee spell attack with the fiery blade. On a hit, the target takes Fire damage equal to 3d6 plus your spellcasting ability modifier.

The flaming blade sheds [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") in a 10-foot radius and [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") for an additional 10 feet.
...
You attempt to turn one creature that you can see within range into stone. The target makes a Constitution saving throw. On a failed save, it has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition for the duration. On a successful save, its Speed is 0 until the start of your next turn. Constructs automatically succeed on the save.

A Restrained target makes another Constitution saving throw at the end of each of its turns. If it successfully saves against this spell three times, the spell ends. If it fails its saves three times, it is turned to stone and has the [Petrified](/sources/dnd/free-rules/rules-glossary#PetrifiedCondition "//www.dndbeyond.com/conditions/10-tooltip?disable-webm=1&disable-webm=1") condition for the duration. The successes and failures needn’t be consecutive; keep track of both until the target collects three of a kind.

If you maintain your [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1") on this spell for the entire possible duration, the target is Petrified until the condition is ended by [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1") or similar magic.
...
You create a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") of fog centered on a point within range. The Sphere is [Heavily Obscured](/sources/dnd/free-rules/rules-glossary#HeavilyObscured "//www.dndbeyond.com/rules-glossary/65-tooltip?disable-webm=1&disable-webm=1"). It lasts for the duration or until a strong wind (such as one created by [Gust of Wind](/spells/2619137-gust-of-wind "//www.dndbeyond.com/spells/2619137-tooltip?disable-webm=1&disable-webm=1")) disperses it.
...
You create a ward against magical travel that protects up to 40,000 square feet of floor space to a height of 30 feet above the floor. For the duration, creatures can’t teleport into the area or use portals, such as those created by the [Gate](/spells/2618932-gate "//www.dndbeyond.com/spells/2618932-tooltip?disable-webm=1&disable-webm=1") spell, to enter the area. The spell proofs the area against planar travel, and therefore prevents creatures from accessing the area by way of the Astral Plane, the Ethereal Plane, the Feywild, the Shadowfell, or the [Plane Shift](/spells/2618867-plane-shift "//www.dndbeyond.com/spells/2618867-tooltip?disable-webm=1&disable-webm=1") spell.
...
An immobile, [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1"), [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1")\-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose.
...
This spell can’t be dispelled by [Dispel Magic](/spells/2619103-dispel-magic "//www.dndbeyond.com/spells/2619103-tooltip?disable-webm=1&disable-webm=1").
...
You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on [D20 Tests](/sources/dnd/free-rules/rules-glossary#D20Test "//www.dndbeyond.com/rules-glossary/41-tooltip?disable-webm=1&disable-webm=1"), and other creatures have [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on attack rolls against it. The spell ends early if you cast it again.
...
A cool light wreathes your body for the duration, emitting [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") in a 20-foot radius and [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") for an additional 20 feet.
...
You touch a willing creature. For the duration, the target’s movement is unaffected by [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1"), and spells and other magical effects can neither reduce the target’s Speed nor cause the target to have the [Paralyzed](/sources/dnd/free-rules/rules-glossary#ParalyzedCondition "//www.dndbeyond.com/conditions/9-tooltip?disable-webm=1&disable-webm=1") or [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") conditions. The target also has a Swim Speed equal to its Speed.

In addition, the target can spend 5 feet of movement to automatically escape from nonmagical restraints, such as manacles or a creature imposing the [Grappled](/sources/dnd/free-rules/rules-glossary#GrappledCondition "//www.dndbeyond.com/conditions/6-tooltip?disable-webm=1&disable-webm=1") condition on it.
...
You magically emanate a sense of friendship toward one creature you can see within range. The target must succeed on a Wisdom saving throw or have the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition for the duration. The target succeeds automatically if it isn’t a Humanoid, if you’re fighting it, or if you have cast this spell on it within the past 24 hours.
...
A [Remove Curse](/spells/2618943-remove-curse "//www.dndbeyond.com/spells/2618943-tooltip?disable-webm=1&disable-webm=1"), [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1"), or [Wish](/spells/2619213-wish "//www.dndbeyond.com/spells/2619213-tooltip?disable-webm=1&disable-webm=1") spell ends this spell.
...
The spell also effectively extends the time limit on raising the target from the dead, since days spent under the influence of this spell don’t count against the time limit of spells such as [Raise Dead](/spells/2618922-raise-dead "//www.dndbeyond.com/spells/2618922-tooltip?disable-webm=1&disable-webm=1").
...
The creature is an ally to you and your allies. In combat, the creature shares your Initiative count, but it takes its turn immediately after yours. It obeys your verbal commands (no action required by you). If you don’t issue any, it takes the [Dodge](/sources/dnd/free-rules/rules-glossary#DodgeAction "//www.dndbeyond.com/actions/6-tooltip?disable-webm=1&disable-webm=1") action and uses its movement to avoid danger.
...
An immobile, shimmering barrier appears in a 10-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") around you and remains for the duration.
...
The glyph is nearly imperceptible and requires a successful Wisdom ([Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC to notice.
...
When the glyph is triggered, the stored spell takes effect. If the spell has a target, it targets the creature that triggered the glyph. If the spell affects an area, the area is centered on that creature. If the spell summons [Hostile](/sources/dnd/free-rules/rules-glossary#HostileAttitude "//www.dndbeyond.com/rules-glossary/70-tooltip?disable-webm=1&disable-webm=1") creatures or creates harmful objects or traps, they appear as close as possible to the intruder and attack it. If the spell requires [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), it lasts until the end of its full duration.
...
Nonflammable grease covers the ground in a 10-foot square centered on a point within range and turns it into [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1") for the duration.

When the grease appears, each creature standing in its area must succeed on a Dexterity saving throw or have the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition. A creature that enters the area or ends its turn there must also succeed on that save or fall Prone.
...
A creature you touch has the [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") condition until the spell ends.
...
-   1 [Exhaustion](/sources/dnd/free-rules/rules-glossary#ExhaustionCondition "//www.dndbeyond.com/conditions/4-tooltip?disable-webm=1&disable-webm=1") level
-   The [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") or [Petrified](/sources/dnd/free-rules/rules-glossary#PetrifiedCondition "//www.dndbeyond.com/conditions/10-tooltip?disable-webm=1&disable-webm=1") condition
-   A curse, including the target’s [Attunement](/sources/dnd/free-rules/rules-glossary#Attunement "//www.dndbeyond.com/rules-glossary/13-tooltip?disable-webm=1&disable-webm=1") to a cursed magic item
...
The spell creates the effects below within the warded area. [Dispel Magic](/spells/2619103-dispel-magic "//www.dndbeyond.com/spells/2619103-tooltip?disable-webm=1&disable-webm=1") has no effect on *Guards and Wards* itself, but each of the following effects can be dispelled. If all four are dispelled, *Guards and Wards* ends. If you cast the spell every day for 365 days on the same area, the spell thereafter lasts until all its effects are dispelled.

***Corridors.*** Fog fills all the warded corridors, making them [Heavily Obscured](/sources/dnd/free-rules/rules-glossary#HeavilyObscured "//www.dndbeyond.com/rules-glossary/65-tooltip?disable-webm=1&disable-webm=1"). In addition, at each intersection or branching passage offering a choice of direction, there is a 50 percent chance that a creature other than you believes it is going in the opposite direction from the one it chooses.

***Doors.*** All doors in the warded area are magically locked, as if sealed by the [Arcane Lock](/spells/2618868-arcane-lock "//www.dndbeyond.com/spells/2618868-tooltip?disable-webm=1&disable-webm=1") spell. In addition, you can cover up to ten doors with an illusion to make them appear as plain sections of wall.

***Stairs.*** Webs fill all stairs in the warded area from top to bottom, as in the [Web](/spells/2619208-web "//www.dndbeyond.com/spells/2619208-tooltip?disable-webm=1&disable-webm=1") spell. These strands regrow in 10 minutes if they are destroyed while *Guards and Wards* lasts.

***Other Spell Effect.*** Place one of the following magical effects within the warded area:

-   [Dancing Lights](/spells/2619058-dancing-lights "//www.dndbeyond.com/spells/2619058-tooltip?disable-webm=1&disable-webm=1") in four corridors, with a simple program that the lights repeat as long as *Guards and Wards* lasts
-   [Magic Mouth](/spells/2619023-magic-mouth "//www.dndbeyond.com/spells/2619023-tooltip?disable-webm=1&disable-webm=1") in two locations
-   [Stinking Cloud](/spells/2619091-stinking-cloud "//www.dndbeyond.com/spells/2619091-tooltip?disable-webm=1&disable-webm=1") in two locations (the vapors return within 10 minutes if dispersed while *Guards and Wards* lasts)
-   [Gust of Wind](/spells/2619137-gust-of-wind "//www.dndbeyond.com/spells/2619137-tooltip?disable-webm=1&disable-webm=1") in one corridor or room (the wind blows continuously while the spell lasts)
-   [Suggestion](/spells/2619101-suggestion "//www.dndbeyond.com/spells/2619101-tooltip?disable-webm=1&disable-webm=1") in one 5-foot square; any creature that enters that square receives the suggestion mentally
...
A [Line](/sources/dnd/free-rules/rules-glossary#LineAreaofEffect "//www.dndbeyond.com/rules-glossary/80-tooltip?disable-webm=1&disable-webm=1") of strong wind 60 feet long and 10 feet wide blasts from you in a direction you choose for the duration. Each creature in the Line must succeed on a Strength saving throw or be pushed 15 feet away from you in a direction following the Line. A creature that ends its turn in the Line must make the same save.
...
***Hallowed Ward.*** Choose any of these creature types: Aberration, Celestial, Elemental, Fey, Fiend, or Undead. Creatures of the chosen types can’t willingly enter the area, and any creature that is [possessed](/sources/dnd/free-rules/rules-glossary#Possession "//www.dndbeyond.com/rules-glossary/92-tooltip?disable-webm=1&disable-webm=1") by or that has the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") or [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition from such creatures isn’t possessed, Charmed, or Frightened by them while in the area.

***Extra Effect.*** You bind an extra effect to the area from the list below:

**Courage.** Creatures of any types you choose can’t gain the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition while in the area.

**Darkness.** [Darkness](/sources/dnd/free-rules/rules-glossary#Darkness "//www.dndbeyond.com/rules-glossary/46-tooltip?disable-webm=1&disable-webm=1") fills the area. Normal light, as well as magical light created by spells of a level lower than this spell, can’t illuminate the area.

**Daylight.** [Bright light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") fills the area. Magical Darkness created by spells of a level lower than this spell can’t extinguish the light.
...
**Fear.** Creatures of any types you choose have the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition while in the area.
...
You make natural terrain in a 150-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") in range look, sound, and smell like another sort of natural terrain. Thus, open fields or a road can be made to resemble a swamp, hill, crevasse, or some other difficult or impassable terrain. A pond can be made to seem like a grassy meadow, a precipice like a gentle slope, or a rock-strewn gully like a wide and smooth road. Manufactured structures, equipment, and creatures within the area aren’t changed.

The tactile characteristics of the terrain are unchanged, so creatures entering the area are likely to notice the illusion. If the difference isn’t obvious by touch, a creature examining the illusion can take the [Study](/sources/dnd/free-rules/rules-glossary#StudyAction "//www.dndbeyond.com/actions/1007-tooltip?disable-webm=1&disable-webm=1") action to make an Intelligence ([Investigation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/8-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC to disbelieve it. If a creature discerns that the terrain is illusory, the creature sees a vague image superimposed on the real terrain.
...
Choose a willing creature that you can see within range. Until the spell ends, the target’s Speed is doubled, it gains a +2 bonus to Armor Class, it has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on Dexterity saving throws, and it gains an additional action on each of its turns. That action can be used to take only the [Attack](/sources/dnd/free-rules/rules-glossary#AttackAction "//www.dndbeyond.com/actions/1-tooltip?disable-webm=1&disable-webm=1") (one attack only), [Dash](/sources/dnd/free-rules/rules-glossary#DashAction "//www.dndbeyond.com/actions/4-tooltip?disable-webm=1&disable-webm=1"), [Disengage](/sources/dnd/free-rules/rules-glossary#DisengageAction "//www.dndbeyond.com/actions/5-tooltip?disable-webm=1&disable-webm=1"), [Hide](/sources/dnd/free-rules/rules-glossary#HideAction "//www.dndbeyond.com/actions/8-tooltip?disable-webm=1&disable-webm=1"), or [Utilize](/sources/dnd/free-rules/rules-glossary#UtilizeAction "//www.dndbeyond.com/actions/11-tooltip?disable-webm=1&disable-webm=1") action.

When the spell ends, the target is [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") and has a Speed of 0 until the end of its next turn, as a wave of lethargy washes over it.
...
For the duration, you emit an aura in a 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1"). While in the aura, creatures of your choice have [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on all saving throws, and other creatures have [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on attack rolls against them. In addition, when a Fiend or an Undead hits an affected creature with a melee attack roll, the attacker must succeed on a Constitution saving throw or have the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition until the end of its next turn.
...
You open a gateway to the Far Realm, a region infested with unspeakable horrors. A 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") of [Darkness](/sources/dnd/free-rules/rules-glossary#Darkness "//www.dndbeyond.com/rules-glossary/46-tooltip?disable-webm=1&disable-webm=1") appears, centered on a point with range and lasting for the duration. The Sphere is [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1"), and it is filled with strange whispers and slurping noises, which can be heard up to 30 feet away. No light, magical or otherwise, can illuminate the area, and creatures fully within it have the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition.
...
Hail falls in a 20-foot-radius, 40-foot-high [Cylinder](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect "//www.dndbeyond.com/rules-glossary/40-tooltip?disable-webm=1&disable-webm=1") centered on a point within range. Each creature in the Cylinder makes a Dexterity saving throw. A creature takes 2d10 Bludgeoning damage and 4d6 Cold damage on a failed save or half as much damage on a successful one.

Hailstones turn ground in the Cylinder into [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1") until the end of your next turn.
...
You touch an object throughout the spell’s casting. If the object is a magic item or some other magical object, you learn its properties and how to use them, whether it requires [Attunement](/sources/dnd/free-rules/rules-glossary#Attunement "//www.dndbeyond.com/rules-glossary/13-tooltip?disable-webm=1&disable-webm=1"), and how many charges it has, if any. You learn whether any ongoing spells are affecting the item and what they are. If the item was created by a spell, you learn that spell’s name.
...
A creature that has [Truesight](/sources/dnd/free-rules/rules-glossary#Truesight "//www.dndbeyond.com/senses/4-tooltip?disable-webm=1&disable-webm=1") can read the hidden message.
...
**Chaining.** Chains firmly rooted in the ground hold the target in place. The target has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition and can’t be moved by any means.
...
**Slumber.** The target has the [Unconscious](/sources/dnd/free-rules/rules-glossary#UnconsciousCondition "//www.dndbeyond.com/conditions/15-tooltip?disable-webm=1&disable-webm=1") condition and can’t be awoken.
...
A [Dispel Magic](/spells/2619103-dispel-magic "//www.dndbeyond.com/spells/2619103-tooltip?disable-webm=1&disable-webm=1") spell can end the spell only if it is cast with a level 9 spell slot, targeting either the prison or the component used to create it.
...
A swirling cloud of embers and smoke fills a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point within range. The cloud’s area is [Heavily Obscured](/sources/dnd/free-rules/rules-glossary#HeavilyObscured "//www.dndbeyond.com/rules-glossary/65-tooltip?disable-webm=1&disable-webm=1"). It lasts for the duration or until a strong wind (like that created by [Gust of Wind](/spells/2619137-gust-of-wind "//www.dndbeyond.com/spells/2619137-tooltip?disable-webm=1&disable-webm=1")) disperses it.

When the cloud appears, each creature in it makes a Dexterity saving throw, taking 10d8 Fire damage on a failed save or half as much damage on a successful one. A creature must also make this save when the [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") moves into its space and when it enters the Sphere or ends its turn there. A creature makes this save only once per turn.
...
Swarming locusts fill a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point you choose within range. The Sphere remains for the duration, and its area is [Lightly Obscured](/sources/dnd/free-rules/rules-glossary#LightlyObscured "//www.dndbeyond.com/rules-glossary/79-tooltip?disable-webm=1&disable-webm=1") and [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1").
...
A creature you touch has the [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") condition until the spell ends. The spell ends early immediately after the target makes an attack roll, deals damage, or casts a spell.
...
You unleash a storm of flashing light and raging thunder in a 10-foot-radius, 40-foot-high [Cylinder](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect "//www.dndbeyond.com/rules-glossary/40-tooltip?disable-webm=1&disable-webm=1") centered on a point you can see within range. While in this area, creatures have the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") and [Deafened](/sources/dnd/free-rules/rules-glossary#DeafenedCondition "//www.dndbeyond.com/conditions/3-tooltip?disable-webm=1&disable-webm=1") conditions, and they can’t cast spells with a Verbal component.
...
If the target is held shut by [Arcane Lock](/spells/2618868-arcane-lock "//www.dndbeyond.com/spells/2618868-tooltip?disable-webm=1&disable-webm=1"), that spell is suppressed for 10 minutes, during which time the target can be opened and closed.
...
While the chest remains on the Ethereal Plane, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action and touch the replica to recall the chest. It appears in an unoccupied space on the ground within 5 feet of you. You can send the chest back to the Ethereal Plane by taking a Magic action to touch the chest and the replica.
...
A 10-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") springs into existence around you and remains stationary for the duration. The spell fails when you cast it if the Emanation isn’t big enough to fully encapsulate all creatures in its area.
...
The spell can locate a specific creature known to you or the nearest creature of a specific kind (such as a human or a unicorn) if you have seen such a creature up close—within 30 feet—at least once. If the creature you described or named is in a different form, such as under the effects of a [Flesh to Stone](/spells/2618905-flesh-to-stone "//www.dndbeyond.com/spells/2618905-tooltip?disable-webm=1&disable-webm=1") or [Polymorph](/spells/2618876-polymorph "//www.dndbeyond.com/spells/2618876-tooltip?disable-webm=1&disable-webm=1") spell, this spell doesn’t locate the creature.
...
As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action on your later turns, you can control the hand thus again. As part of that action, you can move the hand up to 30 feet.
...
You create a 10-foot-radius, 20-foot-tall [Cylinder](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect "//www.dndbeyond.com/rules-glossary/40-tooltip?disable-webm=1&disable-webm=1") of magical energy centered on a point on the ground that you can see within range. Glowing runes appear wherever the Cylinder intersects with the floor or other surface.

Choose one or more of the following types of creatures: Celestials, Elementals, Fey, Fiends, or Undead. The circle affects a creature of the chosen type in the following ways:

-   The creature can’t willingly enter the Cylinder by nonmagical means. If the creature tries to use teleportation or interplanar travel to do so, it must first succeed on a Charisma saving throw.
-   The creature has [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on attack rolls against targets within the Cylinder.
-   Targets within the Cylinder can’t be [possessed](/sources/dnd/free-rules/rules-glossary#Possession "//www.dndbeyond.com/rules-glossary/92-tooltip?disable-webm=1&disable-webm=1") by or gain the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") or [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition from the creature.
...
You can attempt to possess any Humanoid within 100 feet of you that you can see (creatures warded by a [Protection from Evil and Good](/spells/2618912-protection-from-evil-and-good "//www.dndbeyond.com/spells/2618912-tooltip?disable-webm=1&disable-webm=1") or [Magic Circle](/spells/2619018-magic-circle "//www.dndbeyond.com/spells/2619018-tooltip?disable-webm=1&disable-webm=1") spell can’t be [possessed](/sources/dnd/free-rules/rules-glossary#Possession "//www.dndbeyond.com/rules-glossary/92-tooltip?disable-webm=1&disable-webm=1")). The target makes a Charisma saving throw. On a failed save, your soul enters the target’s body, and the target’s soul becomes trapped in the container. On a successful save, the target resists your efforts to possess it, and you can’t attempt to possess it again for 24 hours.
...
Meanwhile, the possessed creature’s soul can perceive from the container using its own senses, but it can’t move and it is [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1").

While possessing a body, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to return from the host body to the container if it is within 100 feet of you, returning the host creature’s soul to its body. If the host body dies while you’re in it, the creature dies, and you make a Charisma saving throw against your own spellcasting DC. On a success, you return to the container if it is within 100 feet of you. Otherwise, you die.
...
You create the image of an object, a creature, or some other visible phenomenon that is no larger than a 20-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1"). The image appears at a spot that you can see within range and lasts for the duration. It seems real, including sounds, smells, and temperature appropriate to the thing depicted, but it can’t deal damage or cause conditions.

If you are within range of the illusion, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to cause the image to move to any other spot within range. As the image changes location, you can alter its appearance so that its movements appear natural for the image. For example, if you create an image of a creature and move it, you can alter the image so that it appears to be walking. Similarly, you can cause the illusion to make different sounds at different times, even making it carry on a conversation, for example.

Physical interaction with the image reveals it to be an illusion, for things can pass through it. A creature that takes a [Study](/sources/dnd/free-rules/rules-glossary#StudyAction "//www.dndbeyond.com/actions/1007-tooltip?disable-webm=1&disable-webm=1") action to examine the image can determine that it is an illusion with a successful Intelligence ([Investigation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/8-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through the image, and its other sensory qualities become faint to the creature.

***Using a Higher-Level Spell Slot.*** The spell lasts until dispelled, without requiring [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), if cast with a level 4+ spell slot.
...
A wave of healing energy washes out from a point you can see within range. Choose up to six creatures in a 30-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on that point. Each target regains Hit Points equal to 5d8 plus your spellcasting ability modifier.
...
Each target must succeed on a Wisdom saving throw or have the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition for the duration or until you or your allies deal damage to the target. Each Charmed target pursues the suggestion to the best of its ability. The suggested activity can continue for the entire duration, but if the suggested activity can be completed in a shorter time, the spell ends for a target upon completing it.
...
The target can take a [Study](/sources/dnd/free-rules/rules-glossary#StudyAction "//www.dndbeyond.com/actions/1007-tooltip?disable-webm=1&disable-webm=1") action to try to escape. When it does so, it makes a DC 20 Intelligence ([Investigation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/8-tooltip?disable-webm=1&disable-webm=1")) check. If it succeeds, it escapes, and the spell ends.
...
Blazing orbs of fire plummet to the ground at four different points you can see within range. Each creature in a 40-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on each of those points makes a Dexterity saving throw. A creature takes 20d6 Fire damage and 20d6 Bludgeoning damage on a failed save or half as much damage on a successful one. A creature in the area of more than one fiery Sphere is affected only once.

A nonmagical object that isn’t being worn or carried also takes the damage if it’s in the spell’s area, and the object starts [burning](/sources/dnd/free-rules/rules-glossary#BurningHazard "//www.dndbeyond.com/rules-glossary/22-tooltip?disable-webm=1&disable-webm=1") if it’s flammable.
...
Until the spell ends, one willing creature you touch has Immunity to Psychic damage and the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition. The target is also unaffected by anything that would sense its emotions or alignment, read its thoughts, or magically detect its location, and no spell—not even [Wish](/spells/2619213-wish "//www.dndbeyond.com/spells/2619213-tooltip?disable-webm=1&disable-webm=1")—can gather information about the target, observe it remotely, or control its mind.
...
A creature is unaffected by this spell if it has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition, [Blindsight](/sources/dnd/free-rules/rules-glossary#Blindsight "//www.dndbeyond.com/senses/1-tooltip?disable-webm=1&disable-webm=1"), or [Truesight](/sources/dnd/free-rules/rules-glossary#Truesight "//www.dndbeyond.com/senses/4-tooltip?disable-webm=1&disable-webm=1").
...
You gain the [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") condition at the same time that an illusory double of you appears where you are standing. The double lasts for the duration, but the invisibility ends immediately after you make an attack roll, deal damage, or cast a spell.

As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, you can move the illusory double up to twice your Speed and make it gesture, speak, and behave in whatever way you choose. It is intangible and invulnerable.
...
A [Remove Curse](/spells/2618943-remove-curse "//www.dndbeyond.com/spells/2618943-tooltip?disable-webm=1&disable-webm=1") or [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1") spell cast on the target restores the creature’s true memory.
...
A silvery beam of pale light shines down in a 5-foot-radius, 40-foot-high [Cylinder](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect "//www.dndbeyond.com/rules-glossary/40-tooltip?disable-webm=1&disable-webm=1") centered on a point within range. Until the spell ends, [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") fills the Cylinder, and you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action on later turns to move the Cylinder up to 60 feet.

When the Cylinder appears, each creature in it makes a Constitution saving throw. On a failed save, a creature takes 2d10 Radiant damage, and if the creature is [shape-shifted](/sources/dnd/free-rules/rules-glossary#ShapeShifting "//www.dndbeyond.com/rules-glossary/100-tooltip?disable-webm=1&disable-webm=1") (as a result of the [Polymorph](/spells/2618876-polymorph "//www.dndbeyond.com/spells/2618876-tooltip?disable-webm=1&disable-webm=1") spell, for example), it reverts to its true form and can’t shape-shift until it leaves the Cylinder. On a successful save, a creature takes half as much damage only. A creature also makes this save when the spell’s area moves into its space and when it enters the spell’s area or ends its turn there. A creature makes this save only once per turn.
...
On your later turns, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to move the hound up to 30 feet.
...
You make an area within range magically secure. The area is a [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") that can be as small as 5 feet to as large as 100 feet on each side. The spell lasts for the duration.
...
-   The barrier of the warded area appears dark and foggy, preventing vision (including [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1")) through it.
...
**Duration:** [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), up to 2 hours
...
***False Aura (Object).*** You change the way the target appears to spells and magical effects that detect magical auras, such as [Detect Magic](/spells/2619097-detect-magic "//www.dndbeyond.com/spells/2619097-tooltip?disable-webm=1&disable-webm=1"). You can make a nonmagical object appear magical, make a magic item appear nonmagical, or change the object’s aura so that it appears to belong to a school of magic you choose.
...
A [Disintegrate](/spells/2619094-disintegrate "//www.dndbeyond.com/spells/2619094-tooltip?disable-webm=1&disable-webm=1") spell targeting the globe destroys it without harming anything inside.
...
You radiate a concealing aura in a 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. While in the aura, you and each creature you choose have a +10 bonus to Dexterity ([Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1")) checks and leave no tracks.
...
You attempt to bind a Celestial, an Elemental, a Fey, or a Fiend to your service. The creature must be within range for the entire casting of the spell. (Typically, the creature is first summoned into the center of the inverted version of the [Magic Circle](/spells/2619018-magic-circle "//www.dndbeyond.com/spells/2619018-tooltip?disable-webm=1&disable-webm=1") spell to trap it while this spell is cast.) At the completion of the casting, the target must succeed on a Charisma saving throw or be bound to serve you for the duration. If the creature was summoned or created by another spell, that spell’s duration is extended to match the duration of this spell.

A bound creature must follow your commands to the best of its ability. You might command the creature to accompany you on an adventure, to guard a location, or to deliver a message. If the creature is [Hostile](/sources/dnd/free-rules/rules-glossary#HostileAttitude "//www.dndbeyond.com/rules-glossary/70-tooltip?disable-webm=1&disable-webm=1"), it strives to twist your commands to achieve its own objectives. If the creature carries out your commands completely before the spell ends, it travels to you to report this fact if you are on the same plane of existence. If you are on a different plane, it returns to the place where you bound it and remains there until the spell ends.
...
You fortify up to six creatures you can see within range. The spell bestows 120 [Temporary Hit Points](/sources/dnd/free-rules/rules-glossary#TemporaryHitPoints "//www.dndbeyond.com/rules-glossary/119-tooltip?disable-webm=1&disable-webm=1"), which you divide among the spell’s recipients.
...
You overwhelm the mind of one creature you can see within range. If the target has 150 Hit Points or fewer, it has the [Stunned](/sources/dnd/free-rules/rules-glossary#StunnedCondition "//www.dndbeyond.com/conditions/14-tooltip?disable-webm=1&disable-webm=1") condition. Otherwise, its Speed is 0 until the start of your next turn.
...
Eight rays of light flash from you in a 60-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). Each creature in the Cone makes a Dexterity saving throw. For each target, roll 1d8 to determine which color ray affects it, consulting the Prismatic Rays table.
...
| 6 | **Indigo.** *Failed Save:* The target has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition and makes a Constitution saving throw at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it has the [Petrified](/sources/dnd/free-rules/rules-glossary#PetrifiedCondition "//www.dndbeyond.com/conditions/10-tooltip?disable-webm=1&disable-webm=1") condition until it is freed by an effect like the [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1") spell. The successes and failures needn’t be consecutive; keep track of both until the target collects three of a kind. |
...
The wall sheds [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") within 100 feet and [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") for an additional 100 feet. You and creatures you designate when you cast the spell can pass through and be near the wall without harm. If another creature that can see the wall moves within 20 feet of it or starts its turn there, the creature must succeed on a Constitution saving throw or have the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition for 1 minute.
...
The wall, which has AC 10, can be destroyed one layer at a time, in order from red to violet, by means specific to each layer. If a layer is destroyed, it is gone for the duration. [Antimagic Field](/spells/2618860-antimagic-field "//www.dndbeyond.com/spells/2618860-tooltip?disable-webm=1&disable-webm=1") has no effect on the wall, and [Dispel Magic](/spells/2619103-dispel-magic "//www.dndbeyond.com/spells/2619103-tooltip?disable-webm=1&disable-webm=1") can affect only the violet layer.
...
| 2 | **Orange.** *Failed Save:* 12d6 Acid damage. *Successful Save:* Half as much damage. *Additional Effects:* Magical ranged attacks can’t pass through this layer, which is destroyed by a strong wind (such as the one created by [Gust of Wind](/spells/2619137-gust-of-wind "//www.dndbeyond.com/spells/2619137-tooltip?disable-webm=1&disable-webm=1")). |
...
| 4 | **Green.** *Failed Save:* 12d6 Poison damage. *Successful Save:* Half as much damage. *Additional Effects:* A [Passwall](/spells/2618852-passwall "//www.dndbeyond.com/spells/2618852-tooltip?disable-webm=1&disable-webm=1") spell, or another spell of equal or greater level that can open a portal on a solid surface, destroys this layer. |
...
| 6 | **Indigo.** *Failed Save:* The target has the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition and makes a Constitution saving throw at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it has the [Petrified](/sources/dnd/free-rules/rules-glossary#PetrifiedCondition "//www.dndbeyond.com/conditions/10-tooltip?disable-webm=1&disable-webm=1") condition until it is freed by an effect like the [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1") spell. The successes and failures needn’t be consecutive; keep track of both until the target collects three of a kind. *Additional Effects:* Spells can’t be cast through this layer, which is destroyed by [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") shed by the [Daylight](/spells/2619083-daylight "//www.dndbeyond.com/spells/2619083-tooltip?disable-webm=1&disable-webm=1") spell. |
| 7 | **Violet.** *Failed Save:* The target has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition and makes a Wisdom saving throw at the start of your next turn. On a successful save, the condition ends. On a failed save, the condition ends, and the creature teleports to another plane of existence (DM’s choice). *Additional Effects:* This layer is destroyed by [Dispel Magic](/spells/2619103-dispel-magic "//www.dndbeyond.com/spells/2619103-tooltip?disable-webm=1&disable-webm=1"). |
...
A flickering flame appears in your hand and remains there for the duration. While there, the flame emits no heat and ignites nothing, and it sheds [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") in a 20-foot radius and [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") for an additional 20 feet. The spell ends if you cast it again.

Until the spell ends, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to hurl fire at a creature or an object within 60 feet of you. Make a ranged spell attack. On a hit, the target takes 1d8 Fire damage.
...
You can see through the illusion’s eyes and hear through its ears as if you were in its space. As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, you can move it up to 60 feet and make it gesture, speak, and behave in whatever way you choose. It mimics your mannerisms perfectly.
...
Until the spell ends, one willing creature you touch is protected against creatures that are Aberrations, Celestials, Elementals, Fey, Fiends, or Undead. The protection grants several benefits. Creatures of those types have [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on attack rolls against the target. The target also can’t be [possessed](/sources/dnd/free-rules/rules-glossary#Possession "//www.dndbeyond.com/rules-glossary/92-tooltip?disable-webm=1&disable-webm=1") by or gain the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") or [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") conditions from them. If the target is already possessed, Charmed, or Frightened by such a creature, the target has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on any new saving throw against the relevant effect.
...
You remove poison and rot from nonmagical food and drink in a 5-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point within range.
...
Coming back from the dead is an ordeal. The target takes a −4 penalty to [D20 Tests](/sources/dnd/free-rules/rules-glossary#D20Test "//www.dndbeyond.com/rules-glossary/41-tooltip?disable-webm=1&disable-webm=1"). Every time the target finishes a [Long Rest](/sources/dnd/free-rules/rules-glossary#LongRest "//www.dndbeyond.com/rules-glossary/82-tooltip?disable-webm=1&disable-webm=1"), the penalty is reduced by 1 until it becomes 0.
...
A beam of enervating energy shoots from you toward a creature within range. The target must make a Constitution saving throw. On a successful save, the target has [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on the next attack roll it makes until the start of your next turn.

On a failed save, the target has Disadvantage on Strength-based [D20 Tests](/sources/dnd/free-rules/rules-glossary#D20Test "//www.dndbeyond.com/rules-glossary/41-tooltip?disable-webm=1&disable-webm=1") for the duration. During that time, it also subtracts 1d8 from all its damage rolls. The target repeats the save at the end of each of its turns, ending the spell on a success.
...
At your touch, all [curses](/sources/dnd/free-rules/rules-glossary#Curses "//www.dndbeyond.com/rules-glossary/39-tooltip?disable-webm=1&disable-webm=1") affecting one creature or object end. If the object is a cursed magic item, its curse remains, but the spell breaks its owner’s Attunement to the object so it can be removed or discarded.
...
Casting this spell to revive a creature that has been dead for 365 days or longer taxes you. Until you finish a Long Rest, you can’t cast spells again, and you have [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on D20 Tests.
...
This spell reverses gravity in a 50-foot-radius, 100-foot high [Cylinder](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect "//www.dndbeyond.com/rules-glossary/40-tooltip?disable-webm=1&disable-webm=1") centered on a point within range. All creatures and objects in that area that aren’t anchored to the ground fall upward and reach the top of the Cylinder. A creature can make a Dexterity saving throw to grab a fixed object it can reach, thus avoiding the fall upward.
...
On a failed save, the spell creates an [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1"), intangible sensor within 10 feet of the target. You can see and hear through the sensor as if you were there. The sensor moves with the target, remaining within 10 feet of it for the duration. If something can see the sensor, it appears as a luminous orb about the size of your fist.
...
For the duration, you see creatures and objects that have the [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") condition as if they were visible, and you can see into the Ethereal Plane. Creatures and objects there appear ghostly.
...
A creature that takes the [Study](/sources/dnd/free-rules/rules-glossary#StudyAction "//www.dndbeyond.com/actions/1007-tooltip?disable-webm=1&disable-webm=1") action to examine a target can make an Intelligence ([Investigation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/8-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC. If it succeeds, it becomes aware that the target is disguised.
...
With a touch, you magically sequester an object or a willing creature. For the duration, the target has the [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") condition and can’t be targeted by Divination spells, detected by magic, or viewed remotely with magic.

If the target is a creature, it enters a state of suspended animation; it has the [Unconscious](/sources/dnd/free-rules/rules-glossary#UnconsciousCondition "//www.dndbeyond.com/conditions/15-tooltip?disable-webm=1&disable-webm=1") condition, doesn’t age, and doesn’t need food, water, or air.
...
You shape-shift into another creature for the duration or until you take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to shape-shift into a different eligible form. The new form must be of a creature that has a Challenge Rating no higher than your level or Challenge Rating. You must have seen the sort of creature before, and it can’t be a Construct or an Undead.

When you cast the spell, you gain a number of [Temporary Hit Points](/sources/dnd/free-rules/rules-glossary#TemporaryHitPoints "//www.dndbeyond.com/rules-glossary/119-tooltip?disable-webm=1&disable-webm=1") equal to the Hit Points of the first form into which you shape-shift. These Temporary Hit Points vanish if any remain when the spell ends.
...
**Casting Time:** Reaction, which you take when you are hit by an attack roll or targeted by the [Magic Missile](/spells/2619022-magic-missile "//www.dndbeyond.com/spells/2619022-tooltip?disable-webm=1&disable-webm=1") spell
...
An imperceptible barrier of magical force protects you. Until the start of your next turn, you have a +5 bonus to AC, including against the triggering attack, and you take no damage from [Magic Missile](/spells/2619022-magic-missile "//www.dndbeyond.com/spells/2619022-tooltip?disable-webm=1&disable-webm=1").
...
A [Club](/equipment/5-club "//www.dndbeyond.com/weapons/5-tooltip?disable-webm=1&disable-webm=1") or [Quarterstaff](/equipment/12-quarterstaff "//www.dndbeyond.com/weapons/12-tooltip?disable-webm=1&disable-webm=1") you are holding is imbued with nature’s power. For the duration, you can use your spellcasting ability instead of Strength for the attack and damage rolls of melee attacks using that weapon, and the weapon’s damage die becomes a d8. If the attack deals damage, it can be Force damage or the weapon’s normal damage type (your choice).
...
Lightning springs from you to a creature that you try to touch. Make a melee spell attack against the target. On a hit, the target takes 1d8 Lightning damage, and it can’t make [Opportunity Attacks](/sources/dnd/free-rules/rules-glossary#OpportunityAttack "//www.dndbeyond.com/actions/1001-tooltip?disable-webm=1&disable-webm=1") until the start of its next turn.
...
For the duration, no sound can be created within or pass through a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point you choose within range. Any creature or object entirely inside the Sphere has Immunity to Thunder damage, and creatures have the [Deafened](/sources/dnd/free-rules/rules-glossary#DeafenedCondition "//www.dndbeyond.com/conditions/3-tooltip?disable-webm=1&disable-webm=1") condition while entirely inside it. Casting a spell that includes a Verbal component is impossible there.
...
You create the image of an object, a creature, or some other visible phenomenon that is no larger than a 15-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1"). The image appears at a spot within range and lasts for the duration. The image is purely visual; it isn’t accompanied by sound, smell, or other sensory effects.

As a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, you can cause the image to move to any spot within range. As the image changes location, you can alter its appearance so that its movements appear natural for the image. For example, if you create an image of a creature and move it, you can alter the image so that it appears to be walking.
...
The simulacrum is [Friendly](/sources/dnd/free-rules/rules-glossary#FriendlyAttitude "//www.dndbeyond.com/rules-glossary/62-tooltip?disable-webm=1&disable-webm=1") to you and creatures you designate. It obeys your commands and acts on your turn in combat. The simulacrum can’t gain levels, and it can’t take Short or [Long Rests](/sources/dnd/free-rules/rules-glossary#LongRest "//www.dndbeyond.com/rules-glossary/82-tooltip?disable-webm=1&disable-webm=1").
...
Each creature of your choice in a 5-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point within range must succeed on a Wisdom saving throw or have the [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") condition until the end of its next turn, at which point it must repeat the save. If the target fails the second save, the target has the [Unconscious](/sources/dnd/free-rules/rules-glossary#UnconsciousCondition "//www.dndbeyond.com/conditions/15-tooltip?disable-webm=1&disable-webm=1") condition for the duration. The spell ends on a target if it takes damage or someone within 5 feet of it takes an action to shake it out of the spell’s effect.

Creatures that don’t sleep, such as elves, or that have Immunity to the [Exhaustion](/sources/dnd/free-rules/rules-glossary#ExhaustionCondition "//www.dndbeyond.com/conditions/4-tooltip?disable-webm=1&disable-webm=1") condition automatically succeed on saves against this spell.
...
Until the spell ends, sleet falls in a 40-foot-tall, 20-foot-radius [Cylinder](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect "//www.dndbeyond.com/rules-glossary/40-tooltip?disable-webm=1&disable-webm=1") centered on a point you choose within range. The area is [Heavily Obscured](/sources/dnd/free-rules/rules-glossary#HeavilyObscured "//www.dndbeyond.com/rules-glossary/65-tooltip?disable-webm=1&disable-webm=1"), and exposed flames in the area are doused.

Ground in the Cylinder is [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1"). When a creature enters the Cylinder for the first time on a turn or starts its turn there, it must succeed on a Dexterity saving throw or have the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition and lose [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1").
...
You alter time around up to six creatures of your choice in a 40-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") within range. Each target must succeed on a Wisdom saving throw or be affected by this spell for the duration.

An affected target’s Speed is halved, it takes a −2 penalty to AC and Dexterity saving throws, and it can’t take Reactions. On its turns, it can take either an action or a Bonus Action, not both, and it can make only one attack if it takes the [Attack](/sources/dnd/free-rules/rules-glossary#AttackAction "//www.dndbeyond.com/actions/1-tooltip?disable-webm=1&disable-webm=1") action. If it casts a spell with a Somatic component, there is a 25 percent chance the spell fails as a result of the target making the spell’s gestures too slowly.
...
Choose a creature within range that has 0 Hit Points and isn’t [dead](/sources/dnd/free-rules/rules-glossary#Dead "//www.dndbeyond.com/rules-glossary/47-tooltip?disable-webm=1&disable-webm=1"). The creature becomes [Stable](/sources/dnd/free-rules/rules-glossary#Stable "//www.dndbeyond.com/rules-glossary/110-tooltip?disable-webm=1&disable-webm=1").
...
For the duration, you can comprehend and verbally communicate with Beasts, and you can use any of the [Influence](/sources/dnd/free-rules/rules-glossary#InfluenceAction "//www.dndbeyond.com/actions/1008-tooltip?disable-webm=1&disable-webm=1") action’s skill options with them.
...
You imbue plants in an immobile 30-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") with limited sentience and animation, giving them the ability to communicate with you and follow your simple commands. You can question plants about events in the spell’s area within the past day, gaining information about creatures that have passed, weather, and other circumstances.

You can also turn [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1") caused by plant growth (such as thickets and undergrowth) into ordinary terrain that lasts for the duration. Or you can turn ordinary terrain where plants are present into Difficult Terrain that lasts for the duration.
...
The ground in a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point within range sprouts hard spikes and thorns. The area becomes [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1") for the duration. When a creature moves into or within the area, it takes 2d4 Piercing damage for every 5 feet it travels.

The transformation of the ground is camouflaged to look natural. Any creature that can’t see the area when the spell is cast must take a [Search](/sources/dnd/free-rules/rules-glossary#SearchAction "//www.dndbeyond.com/actions/10-tooltip?disable-webm=1&disable-webm=1") action and succeed on a Wisdom ([Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") or [Survival](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/15-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC to recognize the terrain as hazardous before entering it.
...
Protective spirits flit around you in a 15-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") for the duration. If you are good or neutral, their spectral form appears angelic or fey (your choice). If you are evil, they appear fiendish.
...
The target takes an extra 4d6 Psychic damage from the attack, and the target must succeed on a Wisdom saving throw or have the [Stunned](/sources/dnd/free-rules/rules-glossary#StunnedCondition "//www.dndbeyond.com/conditions/14-tooltip?disable-webm=1&disable-webm=1") condition until the end of your next turn.
...
You create a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") of yellow, nauseating gas centered on a point within range. The cloud is [Heavily Obscured](/sources/dnd/free-rules/rules-glossary#HeavilyObscured "//www.dndbeyond.com/rules-glossary/65-tooltip?disable-webm=1&disable-webm=1"). The cloud lingers in the air for the duration or until a strong wind (such as the one created by [Gust of Wind](/spells/2619137-gust-of-wind "//www.dndbeyond.com/spells/2619137-tooltip?disable-webm=1&disable-webm=1")) disperses it.

Each creature that starts its turn in the Sphere must succeed on a Constitution saving throw or have the [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1") condition until the end of the current turn. While Poisoned in this way, the creature can’t take an action or a Bonus Action.
...
The target must succeed on a Wisdom saving throw or have the [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") condition for the duration or until you or your allies deal damage to the target. The Charmed target pursues the suggestion to the best of its ability. The suggested activity can continue for the entire duration, but if the suggested activity can be completed in a shorter time, the spell ends for the target upon completing it.
...
**Senses** [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") 60 ft.; Passive Perception 10
...
***Whispering Aura (Mind Flayer Only).*** At the start of each of the spirit’s turns, the spirit emits psionic energy if it doesn’t have the [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") condition. *Wisdom Saving Throw:* DC equals your spell save DC, each creature (other than you) within 5 feet of the spirit. *Failure:* 2d6 Psychic damage.
...
***Flyby (Air Only).*** The spirit doesn’t provoke [Opportunity Attacks](/sources/dnd/free-rules/rules-glossary#OpportunityAttack "//www.dndbeyond.com/actions/1001-tooltip?disable-webm=1&disable-webm=1") when it flies out of an enemy’s reach.

***Pack Tactics (Land and Water Only).*** The spirit has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on an attack roll against a creature if at least one of the spirit’s allies is within 5 feet of the creature and the ally doesn’t have the [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") condition.
...
**Immunities** [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1"), [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1")
...
**Senses** [Blindsight](/sources/dnd/free-rules/rules-glossary#Blindsight "//www.dndbeyond.com/senses/1-tooltip?disable-webm=1&disable-webm=1") 30 ft., [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1") 60 ft.; Passive Perception 12
...
***Breath Weapon.****Dexterity Saving Throw:* DC equals your spell save DC, each creature in a 30-foot [Cone](/sources/dnd/free-rules/rules-glossary#ConeAreaofEffect "//www.dndbeyond.com/rules-glossary/17-tooltip?disable-webm=1&disable-webm=1"). *Failure:* 2d6 damage of a type this spirit has Resistance to (your choice when you cast the spell). *Success:* Half damage.
...
**Immunities** Fire (Fire only), Poison; [Exhaustion](/sources/dnd/free-rules/rules-glossary#ExhaustionCondition "//www.dndbeyond.com/conditions/4-tooltip?disable-webm=1&disable-webm=1"), [Paralyzed](/sources/dnd/free-rules/rules-glossary#ParalyzedCondition "//www.dndbeyond.com/conditions/9-tooltip?disable-webm=1&disable-webm=1"), [Petrified](/sources/dnd/free-rules/rules-glossary#PetrifiedCondition "//www.dndbeyond.com/conditions/10-tooltip?disable-webm=1&disable-webm=1"), [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1")
...
***Amorphous Form (Air, Fire, and Water Only).*** The spirit can move through a space as narrow as 1 inch wide without it counting as [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1").
...
**Immunities** [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1")
...
**Fuming.** The spirit has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on the next attack roll it makes before the end of this turn.

**Mirthful.** *Wisdom Saving Throw:* DC equals your spell save DC, one creature the spirit can see within 10 feet of itself. *Failure:* The target is [Charmed](/sources/dnd/free-rules/rules-glossary#CharmedCondition "//www.dndbeyond.com/conditions/2-tooltip?disable-webm=1&disable-webm=1") by you and the spirit for 1 minute or until the target takes any damage.

**Tricksy.** The spirit fills a 10-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") within 5 feet of it with magical [Darkness](/sources/dnd/free-rules/rules-glossary#Darkness "//www.dndbeyond.com/rules-glossary/46-tooltip?disable-webm=1&disable-webm=1"), which lasts until the end of its next turn.
...
**Immunities** Poison; [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1")
...
***Death Throes (Demon Only).*** When the spirit drops to 0 Hit Points or the spell ends, the spirit explodes. *Dexterity Saving Throw:* DC equals your spell save DC, each creature in a 10-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") originating from the spirit. *Failure:* 2d10 plus this spell’s level Fire damage. *Success:* Half damage.

***Devil’s Sight (Devil Only).*** Magical [Darkness](/sources/dnd/free-rules/rules-glossary#Darkness "//www.dndbeyond.com/rules-glossary/46-tooltip?disable-webm=1&disable-webm=1") doesn’t impede the spirit’s [Darkvision](/sources/dnd/free-rules/rules-glossary#Darkvision "//www.dndbeyond.com/senses/2-tooltip?disable-webm=1&disable-webm=1").

***Magic Resistance.*** The spirit has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on saving throws against spells and other magical eff ects.
...
**Immunities** Necrotic, Poison; [Exhaustion](/sources/dnd/free-rules/rules-glossary#ExhaustionCondition "//www.dndbeyond.com/conditions/4-tooltip?disable-webm=1&disable-webm=1"), [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1"), [Paralyzed](/sources/dnd/free-rules/rules-glossary#ParalyzedCondition "//www.dndbeyond.com/conditions/9-tooltip?disable-webm=1&disable-webm=1"), [Poisoned](/sources/dnd/free-rules/rules-glossary#PoisonedCondition "//www.dndbeyond.com/conditions/11-tooltip?disable-webm=1&disable-webm=1")
...
***Incorporeal Passage (Ghostly Only).*** The spirit can move through other creatures and objects as if they were [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1"). If it ends its turn inside an object, it is shunted to the nearest unoccupied space and takes 1d10 Force damage for every 5 feet traveled.

Actions

***Multiattack.*** The spirit makes a number of attacks equal to half this spell’s level (round down).

***Deathly Touch (Ghostly Only).*** *Melee Attack Roll:* Bonus equals your spell attack modifier, reach 5 ft. *Hit:* 1d8 + 3 + the spell’s level Necrotic damage, and the target has the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition until the end of its next turn.
...
You launch a sunbeam in a 5-foot-wide, 60-foot-long [Line](/sources/dnd/free-rules/rules-glossary#LineAreaofEffect "//www.dndbeyond.com/rules-glossary/80-tooltip?disable-webm=1&disable-webm=1"). Each creature in the Line makes a Constitution saving throw. On a failed save, a creature takes 6d8 Radiant damage and has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition until the start of your next turn. On a successful save, it takes half as much damage only.

Until the spell ends, you can take a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action to create a new Line of radiance.

For the duration, a mote of brilliant radiance shines above you. It sheds [Bright Light](/sources/dnd/free-rules/rules-glossary#BrightLight "//www.dndbeyond.com/rules-glossary/21-tooltip?disable-webm=1&disable-webm=1") in a 30-foot radius and [Dim Light](/sources/dnd/free-rules/rules-glossary#DimLight "//www.dndbeyond.com/rules-glossary/52-tooltip?disable-webm=1&disable-webm=1") for an additional 30 feet. This light is sunlight.
...
Brilliant sunlight flashes in a 60-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point you choose within range. Each creature in the Sphere makes a Constitution saving throw. On a failed save, a creature takes 12d6 Radiant damage and has the [Blinded](/sources/dnd/free-rules/rules-glossary#BlindedCondition "//www.dndbeyond.com/conditions/1-tooltip?disable-webm=1&disable-webm=1") condition for 1 minute. On a successful save, it takes half as much damage only.
...
This spell dispels [Darkness](/sources/dnd/free-rules/rules-glossary#Darkness "//www.dndbeyond.com/rules-glossary/46-tooltip?disable-webm=1&disable-webm=1") in its area that was created by any spell.
...
***Discord.*** Each target makes a Wisdom saving throw. On a failed save, a target argues with other creatures for 1 minute. During this time, it is incapable of meaningful communication and has [Disadvantage](/sources/dnd/free-rules/rules-glossary#Disadvantage "//www.dndbeyond.com/rules-glossary/53-tooltip?disable-webm=1&disable-webm=1") on attack rolls and ability checks.

***Fear.*** Each target must succeed on a Wisdom saving throw or have the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition for 1 minute. While Frightened, the target must move at least 30 feet away from the glyph on each of its turns, if able.

***Pain.*** Each target must succeed on a Constitution saving throw or have the [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") condition for 1 minute.

***Sleep.*** Each target must succeed on a Wisdom saving throw or have the [Unconscious](/sources/dnd/free-rules/rules-glossary#UnconsciousCondition "//www.dndbeyond.com/conditions/15-tooltip?disable-webm=1&disable-webm=1") condition for 10 minutes. A creature awakens if it takes damage or if someone takes an action to shake it awake.

***Stunning.*** Each target must succeed on a Wisdom saving throw or have the [Stunned](/sources/dnd/free-rules/rules-glossary#StunnedCondition "//www.dndbeyond.com/conditions/14-tooltip?disable-webm=1&disable-webm=1") condition for 1 minute.
...
The liquid in the cauldron duplicates the properties of a Common or an Uncommon potion of your choice (such as a [Potion of Healing](/magic-items/8960641-potion-of-healing "//www.dndbeyond.com/magic-items/8960641-tooltip?disable-webm=1&disable-webm=1")). As a Bonus Action, you or an ally can reach into the cauldron and withdraw one potion of that kind. The potion is contained in a vial that disappears when the potion is consumed. The cauldron can produce a number of these potions equal to your spellcasting ability modifier (minimum 1). When the last of these potions is withdrawn from the cauldron, the cauldron disappears, and the spell ends.
...
One creature of your choice that you can see within range makes a Wisdom saving throw. On a failed save, it has the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") and [Incapacitated](/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition "//www.dndbeyond.com/conditions/7-tooltip?disable-webm=1&disable-webm=1") conditions for the duration. During that time, it laughs uncontrollably if it’s capable of laughter, and it can’t end the [Prone](/sources/dnd/free-rules/rules-glossary#ProneCondition "//www.dndbeyond.com/conditions/12-tooltip?disable-webm=1&disable-webm=1") condition on itself.

At the end of each of its turns and each time it takes damage, it makes another Wisdom saving throw. The target has [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on the save if the save is triggered by damage. On a successful save, the spell ends.
...
***Booming Voice.*** Your voice booms up to three times as loud as normal for 1 minute. For the duration, you have [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage "//www.dndbeyond.com/rules-glossary/4-tooltip?disable-webm=1&disable-webm=1") on Charisma ([Intimidation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/17-tooltip?disable-webm=1&disable-webm=1")) checks.
...
Each creature in a 5-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1") originating from you must succeed on a Constitution saving throw or take 1d6 Thunder damage. The spell’s thunderous sound can be heard up to 100 feet away.
...
You unleash a wave of thunderous energy. Each creature in a 15-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") originating from you makes a Constitution saving throw. On a failed save, a creature takes 2d8 Thunder damage and is pushed 10 feet away from you. On a successful save, a creature takes half as much damage only.
...
The target gains a number of [Temporary Hit Points](/sources/dnd/free-rules/rules-glossary#TemporaryHitPoints "//www.dndbeyond.com/rules-glossary/119-tooltip?disable-webm=1&disable-webm=1") equal to the Hit Points of the new form. These Temporary Hit Points vanish if any remain when the spell ends.

The target is limited in the actions it can perform by the anatomy of its new form, and it can’t speak or cast spells.

The target’s gear melds into the new form. The creature can’t use or otherwise benefit from any of that equipment.

***Object into Creature.*** You can turn an object into any kind of creature, as long as the creature’s size is no larger than the object’s size and the creature has a Challenge Rating of 9 or lower. The creature is [Friendly](/sources/dnd/free-rules/rules-glossary#FriendlyAttitude "//www.dndbeyond.com/rules-glossary/62-tooltip?disable-webm=1&disable-webm=1") to you and your allies. In combat, it takes its turns immediately after yours, and it obeys your commands.
...
For the duration, the willing creature you touch has [Truesight](/sources/dnd/free-rules/rules-glossary#Truesight "//www.dndbeyond.com/senses/4-tooltip?disable-webm=1&disable-webm=1") with a range of 120 feet.
...
**Duration:** [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1"), up to 6 rounds
...
This spell creates an [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1"), mindless, shapeless, Medium force that performs simple tasks at your command until the spell ends. The servant springs into existence in an unoccupied space on the ground within range. It has AC 10, 1 Hit Point, and a Strength of 2, and it can’t attack. If it drops to 0 Hit Points, the spell ends.
...
Until the spell ends, you can make the attack again on each of your turns as a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction "//www.dndbeyond.com/actions/2-tooltip?disable-webm=1&disable-webm=1") action, targeting the same creature or a different one.
...
An [Invisible](/sources/dnd/free-rules/rules-glossary#InvisibleCondition "//www.dndbeyond.com/conditions/8-tooltip?disable-webm=1&disable-webm=1") wall of force springs into existence at a point you choose within range. The wall appears in any orientation you choose, as a horizontal or vertical barrier or at an angle. It can be free floating or resting on a solid surface. You can form it into a hemispherical dome or a globe with a radius of up to 10 feet, or you can shape a flat surface made up of ten 10-foot-by-10-foot panels. Each panel must be contiguous with another panel. In any form, the wall is 1/4 inch thick and lasts for the duration. If the wall cuts through a creature’s space when it appears, the creature is pushed to one side of the wall (you choose which side).

Nothing can physically pass through the wall. It is immune to all damage and can’t be dispelled by [Dispel Magic](/spells/2619103-dispel-magic "//www.dndbeyond.com/spells/2619103-tooltip?disable-webm=1&disable-webm=1"). A [Disintegrate](/spells/2619094-disintegrate "//www.dndbeyond.com/spells/2619094-tooltip?disable-webm=1&disable-webm=1") spell destroys the wall instantly, however. The wall also extends into the Ethereal Plane and blocks ethereal travel through the wall.
...
If you maintain your [Concentration](/sources/dnd/free-rules/rules-glossary#Concentration "//www.dndbeyond.com/rules-glossary/31-tooltip?disable-webm=1&disable-webm=1") on this spell for its full duration, the wall becomes permanent and can’t be dispelled. Otherwise, the wall disappears when the spell ends.
...
You conjure a mass of sticky webbing at a point within range. The webs fill a 20-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") there for the duration. The webs are [Difficult Terrain](/sources/dnd/free-rules/rules-glossary#DifficultTerrain "//www.dndbeyond.com/rules-glossary/50-tooltip?disable-webm=1&disable-webm=1"), and the area within them is [Lightly Obscured](/sources/dnd/free-rules/rules-glossary#LightlyObscured "//www.dndbeyond.com/rules-glossary/79-tooltip?disable-webm=1&disable-webm=1").

If the webs aren’t anchored between two solid masses (such as walls or trees) or layered across a floor, wall, or ceiling, the web collapses on itself, and the spell ends at the start of your next turn. Webs layered over a flat surface have a depth of 5 feet.

The first time a creature enters the webs on a turn or starts its turn there, it must succeed on a Dexterity saving throw or have the [Restrained](/sources/dnd/free-rules/rules-glossary#RestrainedCondition "//www.dndbeyond.com/conditions/13-tooltip?disable-webm=1&disable-webm=1") condition while in the webs or until it breaks free.

A creature Restrained by the webs can take an action to make a Strength ([Athletics](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/2-tooltip?disable-webm=1&disable-webm=1")) check against your spell save DC. If it succeeds, it is no longer Restrained.

The webs are flammable. Any 5-foot [Cube](/sources/dnd/free-rules/rules-glossary#CubeAreaofEffect "//www.dndbeyond.com/rules-glossary/38-tooltip?disable-webm=1&disable-webm=1") of webs exposed to fire burns away in 1 round, dealing 2d4 Fire damage to any creature that starts its turn in the fire.
...
You try to create illusory terrors in others’ minds. Each creature of your choice in a 30-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point within range makes a Wisdom saving throw. On a failed save, a target takes 10d10 Psychic damage and has the [Frightened](/sources/dnd/free-rules/rules-glossary#FrightenedCondition "//www.dndbeyond.com/conditions/5-tooltip?disable-webm=1&disable-webm=1") condition for the duration. On a successful save, a target takes half as much damage only.
...
**Instant Health.** You allow yourself and up to twenty creatures that you can see to regain all Hit Points, and you end all effects on them listed in the [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1") spell.
...
The spell ends if the target is ever outside the spell’s range or if it has [Total Cover](/sources/dnd/free-rules/rules-glossary#Cover "//www.dndbeyond.com/rules-glossary/33-tooltip?disable-webm=1&disable-webm=1") from you.
...
Burning radiance erupts from you in a 5-foot [Emanation](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect "//www.dndbeyond.com/rules-glossary/54-tooltip?disable-webm=1&disable-webm=1"). Each creature of your choice that you can see in it must succeed on a Constitution saving throw or take 1d6 Radiant damage.
...
You create a magical zone that guards against deception in a 15-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect "//www.dndbeyond.com/rules-glossary/109-tooltip?disable-webm=1&disable-webm=1") centered on a point within range. Until the spell ends, a creature that enters the spell’s area for the first time on a turn or starts its turn there makes a Charisma saving throw. On a failed save, a creature can’t speak a deliberate lie while in the radius. You know whether a creature succeeds or fails on this save.

An affected creature is aware of the spell and can avoid answering questions to which it would normally respond with a lie. Such a creature can be evasive yet must be truthful.

---

*Source: https://www.dndbeyond.com/sources/dnd/phb-2024/spell-descriptions*