# Rules Glossary - Player’s Handbook - Dungeons & Dragons - Sources - D&D Beyond
...
<table class="table-compendium table--left-all" data-content-chunk-id="8afabea0-c564-4f91-bb1a-857615bb0b88"><tbody><tr><th>AC</th><td>Armor Class</td></tr><tr><th>C</th><td>Concentration</td></tr><tr><th>CE</th><td>Chaotic Evil</td></tr><tr><th>CG</th><td>Chaotic Good</td></tr><tr><th>Cha.</th><td>Charisma</td></tr><tr><th>CN</th><td>Chaotic Neutral</td></tr><tr><th>Con.</th><td>Constitution</td></tr><tr><th>CP</th><td>Copper Piece(s)</td></tr><tr><th>CR</th><td>Challenge Rating</td></tr><tr><th>DC</th><td>Difficulty Class</td></tr><tr><th>Dex.</th><td>Dexterity</td></tr><tr><th>DM</th><td>Dungeon Master</td></tr><tr><th>EP</th><td>Electrum Piece(s)</td></tr><tr><th>GP</th><td>Gold Piece(s)</td></tr><tr><th>HP</th><td>Hit Point(s)</td></tr><tr><th>Int.</th><td>Intelligence</td></tr><tr><th>LE</th><td>Lawful Evil</td></tr><tr><th>LG</th><td>Lawful Good</td></tr><tr><th>LN</th><td>Lawful Neutral</td></tr><tr><th>M</th><td>Material component</td></tr><tr><th>N</th><td>Neutral</td></tr><tr><th>NE</th><td>Neutral Evil</td></tr><tr><th>NG</th><td>Neutral Good</td></tr><tr><th>NPC</th><td>Nonplayer character</td></tr><tr><th>PB</th><td>Proficiency Bonus</td></tr><tr><th>PP</th><td>Platinum Piece(s)</td></tr><tr><th>R</th><td>Ritual</td></tr><tr><th>S</th><td>Somatic component</td></tr><tr><th>SP</th><td>Silver Piece(s)</td></tr><tr><th>Str.</th><td>Strength</td></tr><tr><th>V</th><td>Verbal component</td></tr><tr><th>Wis.</th><td>Wisdom</td></tr><tr><th>XP</th><td>Experience Point(s)</td></tr></tbody></table>
...
At the DM’s option, climbing a slippery surface or one with few handholds might require a successful DC 15 Strength ([Athletics](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/2-tooltip?disable-webm=1&disable-webm=1")) check.
...
Some game effects curse a creature or an object. The effect that confers a curse defines what the curse does. Curses can be removed by the [Remove Curse](/spells/2618943-remove-curse "//www.dndbeyond.com/spells/2618943-tooltip?disable-webm=1&disable-webm=1") and [Greater Restoration](/spells/2618961-greater-restoration "//www.dndbeyond.com/spells/2618961-tooltip?disable-webm=1&disable-webm=1") spells or other magic that explicitly ends curses.
...
A dead creature has no [Hit Points](#HitPoints) and can’t regain them unless it is first revived by magic such as the [Raise Dead](/spells/2618922-raise-dead "//www.dndbeyond.com/spells/2618922-tooltip?disable-webm=1&disable-webm=1") or [Revivify](/spells/2618956-revivify "//www.dndbeyond.com/spells/2618956-tooltip?disable-webm=1&disable-webm=1") spell. When such a spell is cast, the spirit knows who is casting it and can refuse. The spirit of a dead creature has left the body and departed for the Outer Planes, and reviving the creature requires calling the spirit back.
...
As they overcome challenges and complete adventures, characters earn Experience Points (XP), which are awarded by the Dungeon Master. When a character’s XP total crosses certain thresholds, the character’s level increases. The [Dungeon Master’s Guide](/sources/dnd/dmg-2024) provides guidance on awarding XP. *See also* chapter 2 (“[Level Advancement](/sources/dnd/phb-2024/creating-a-character#LevelAdvancement)”).
...
With the Hide action, you try to conceal yourself. To do so, you must succeed on a DC 15 Dexterity ([Stealth](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/5-tooltip?disable-webm=1&disable-webm=1")) check while you’re [Heavily Obscured](#HeavilyObscured) or behind [Three-Quarters Cover](/sources/dnd/free-rules/rules-glossary#Cover "//www.dndbeyond.com/rules-glossary/32-tooltip?disable-webm=1&disable-webm=1") or [Total Cover](/sources/dnd/free-rules/rules-glossary#Cover "//www.dndbeyond.com/rules-glossary/33-tooltip?disable-webm=1&disable-webm=1"), and you must be out of any enemy’s line of sight; if you can see a creature, you can discern whether it can see you.

On a successful check, you have the [Invisible](#InvisibleCondition) condition while hidden. Make note of your check’s total, which is the DC for a creature to find you with a Wisdom ([Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1")) check.
...
| --- | --- |
| Charisma ([Deception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/16-tooltip?disable-webm=1&disable-webm=1")) | Deceiving a monster that understands you |
| Charisma ([Intimidation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/17-tooltip?disable-webm=1&disable-webm=1")) | Intimidating a monster |
| Charisma ([Performance](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/18-tooltip?disable-webm=1&disable-webm=1")) | Amusing a monster |
| Charisma ([Persuasion](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/19-tooltip?disable-webm=1&disable-webm=1")) | Persuading a monster that understands you |
| Wisdom ([Animal Handling](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/11-tooltip?disable-webm=1&disable-webm=1")) | Gently coaxing a Beast or Monstrosity |
...
The creature remains Unconscious until it regains any Hit Points or until someone uses an action to administer first aid to it, which requires a successful DC 10 Wisdom ([Medicine](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/13-tooltip?disable-webm=1&disable-webm=1")) check.

* * *

### Lightly Obscured

You have [Disadvantage](#Disadvantage) on Wisdom ([Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1")) checks to see something in a Lightly Obscured space. *See also* “[Dim Light](#DimLight)” and chapter 1 (“[Exploration](/sources/dnd/phb-2024/playing-the-game#Light)”).
...
If you land in [Difficult Terrain](#DifficultTerrain), you must succeed on a DC 10 Dexterity ([Acrobatics](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/3-tooltip?disable-webm=1&disable-webm=1")) check or have the [Prone](#ProneCondition) condition.
...
Some effects cause a creature to be possessed by another creature or entity. A possessing effect defines how the possession operates. Possession can be prevented by the [Protection from Evil and Good](/spells/2618912-protection-from-evil-and-good "//www.dndbeyond.com/spells/2618912-tooltip?disable-webm=1&disable-webm=1") spell and ended by the [Dispel Evil and Good](/spells/2619096-dispel-evil-and-good "//www.dndbeyond.com/spells/2619096-tooltip?disable-webm=1&disable-webm=1") spell.
...
| --- | --- |
| [Insight](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/12-tooltip?disable-webm=1&disable-webm=1") | Creature’s state of mind |
| [Medicine](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/13-tooltip?disable-webm=1&disable-webm=1") | Creature’s ailment or cause of death |
| [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") | Concealed creature or object |
| [Survival](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/15-tooltip?disable-webm=1&disable-webm=1") | Tracks or food |

* * *

### Shape-Shifting

If an effect, such as Wild Shape or the [Polymorph](/spells/2618876-polymorph "//www.dndbeyond.com/spells/2618876-tooltip?disable-webm=1&disable-webm=1") spell, lets you shape-shift, its description specifies what happens to you. Unless that description says otherwise, any ongoing effects on you—[conditions](#Condition), [spells](#Spell), [curses](#Curses), and the like—carry over from one form to the other. You revert to your true form if you die.
...
| Skill | Areas |
| --- | --- |
| [Arcana](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/6-tooltip?disable-webm=1&disable-webm=1") | Spells, magic items, eldritch symbols, magical traditions, planes of existence, and certain creatures (Aberrations, Constructs, Elementals, Fey, and Monstrosities) |
| [History](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/7-tooltip?disable-webm=1&disable-webm=1") | Historic events and people, ancient civilizations, wars, and certain creatures (Giants and Humanoids) |
| [Investigation](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/8-tooltip?disable-webm=1&disable-webm=1") | Traps, ciphers, riddles, and gadgetry |
| [Nature](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/9-tooltip?disable-webm=1&disable-webm=1") | Terrain, flora, weather, and certain creatures (Beasts, Dragons, Oozes, and Plants) |
| [Religion](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/10-tooltip?disable-webm=1&disable-webm=1") | Deities, religious hierarchies and rites, holy symbols, cults, and certain creatures (Celestials, Fiends, and Undead) |
...
*Source: https://www.dndbeyond.com/sources/dnd/phb-2024/rules-glossary*