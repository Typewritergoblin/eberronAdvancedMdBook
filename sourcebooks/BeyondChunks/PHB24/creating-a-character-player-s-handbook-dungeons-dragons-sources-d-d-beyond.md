# Creating a Character - Player’s Handbook - Dungeons & Dragons - Sources - D&D Beyond
...
[Ch. 1: Playing the Game](./playing-the-game)
...
Write your character’s level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [Experience Points](/sources/dnd/free-rules/rules-glossary#ExperiencePoints "//www.dndbeyond.com/rules-glossary/57-tooltip?disable-webm=1&disable-webm=1") (XP).
...
Your character’s [size](/sources/dnd/free-rules/rules-glossary#Size "//www.dndbeyond.com/rules-glossary/103-tooltip?disable-webm=1&disable-webm=1") and [Speed](/sources/dnd/free-rules/rules-glossary#Speed "//www.dndbeyond.com/rules-glossary/105-tooltip?disable-webm=1&disable-webm=1") are determined by the character’s species; record these in the appropriate places on your character sheet as well (you may write just the first letter of your size).
...
> Unaligned Creatures
> 
> Most creatures that lack the capacity for rational thought don’t have alignments; they are unaligned. [Sharks](/monsters/4775838-reef-shark "//www.dndbeyond.com/monsters/4775838-tooltip?disable-webm=1&disable-webm=1") are savage predators, for example, but they aren’t evil; they are unaligned.
...
***Passive Perception.*** Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1")) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you’re not actively looking for something. Use this formula to determine your Passive Perception score:

**Passive Perception** = 10 + Wisdom ([Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1")) check modifier

Include all modifiers that apply to your Wisdom ([Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1")) checks. For example, if your character has a Wisdom of 15 and proficiency in the [Perception](/sources/dnd/free-rules/playing-the-game#Skills "//www.dndbeyond.com/skills/14-tooltip?disable-webm=1&disable-webm=1") skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
While going on adventures, your character gains experience, represented by [Experience Points](/sources/dnd/free-rules/rules-glossary#ExperiencePoints "//www.dndbeyond.com/rules-glossary/57-tooltip?disable-webm=1&disable-webm=1") (XP). A character who reaches a specified Experience Point total advances in capability. This advancement is called gaining a level.
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [Fireball](/spells/2618887-fireball "//www.dndbeyond.com/spells/2618887-tooltip?disable-webm=1&disable-webm=1"), [Lightning Bolt](/spells/2618999-lightning-bolt "//www.dndbeyond.com/spells/2618999-tooltip?disable-webm=1&disable-webm=1"), and [Raise Dead](/spells/2618922-raise-dead "//www.dndbeyond.com/spells/2618922-tooltip?disable-webm=1&disable-webm=1"). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](/spells/2618946-burning-hands "//www.dndbeyond.com/spells/2618946-tooltip?disable-webm=1&disable-webm=1"), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
*Source: https://www.dndbeyond.com/sources/dnd/phb-2024/creating-a-character*