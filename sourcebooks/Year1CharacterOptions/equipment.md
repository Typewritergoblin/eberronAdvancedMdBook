...
### Spell Scroll (Cantrip and Level 1)
...
A mount can help you move more quickly through the wilderness, but its primary purpose is to carry gear that would otherwise slow you down. The [Mounts and Other Animals table](#mounts-and-other-animals) shows each animal’s carrying capacity. See appendix B for the animals’ stat blocks.
...
Barding is armor designed for a mount. Any type of armor on the [Armor table](armor.md#armor) in this chapter can be purchased as barding. The cost is four times the normal cost, and it weighs twice as much.
...
The “[Tools](tools.md)” chapter lists which tools are required to make certain items. The DM assigns required tools for items not listed there.
