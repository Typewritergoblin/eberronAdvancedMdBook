...
A mount can help you move more quickly through the wilderness, but its primary purpose is to carry gear that would otherwise slow you down. The [Mounts and Other Animals table](#MountsandOtherAnimals) shows each animal’s carrying capacity. See appendix B for the animals’ stat blocks.
