...
*Channel Divine Devotion into Psychic Power*
...
When an ally you can see within 30 feet of yourself fails a saving throw, you can replace the roll with a 20, potentially changing the outcome. Once you use this feature, you can’t use it again until you finish a Short or Long Rest.
...
Tempest Domain clerics channel the raw fury of storms, wielding lightning and thunder as extensions of their divine will. They are aggressive combatants who wade into the heart of battle, punishing foes who dare strike them and devastating entire formations with unleashed elemental power.

#### Level 3: Tempest Domain Spells

Your connection to this domain ensures you always have certain spells ready. When you reach a Cleric level specified in the Tempest Domain Spells table, you thereafter always have the listed spells prepared.

#### Tempest Domain Spells

|**Cleric Level**|**Prepared Spells**|
|---|---|
|3|_Ice Knife, Thunderwave, Misty Step, Gust of Wind_|
|5|_Lightning Bolt, Call Lightning_|
|7|_Ice Storm, Control Water_|
|9|_Cone of Cold, Storm of Radiance_|

#### Level 3: Stormbringer

When dealing Radiant, Fire, Cold, or Force damage, you can instead deal Lightning or Thunder damage.
...
You can use your Channel Divinity to wield the power of the storm with unchecked ferocity. When you roll Lightning or Thunder damage, you can use your Channel Divinity to have a number of dice equal to 1 + your proficiency modifier automatically deal maximum damage. Remaining dice must be rolled normally.
